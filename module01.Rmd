...
## Introdução ao QGIS e à interface do QGIS
...
### **Tutorial/Exercício: Mudando a aparência e layout da interface QGIS**
...
### **Tutorial/Exercício: Instalando um complemento QGIS**
...
### **Tutorial/Exercício: Criando um Perfil de Usuário**

1. Vá para **Configurações > Perfis de usuário > Novo perfil ...**

![Opção novo perfil](media/modulo1/user-profiles-2.png "Opção novo perfil")


2. Dê um nome ao seu novo perfil de usuário.

![caixa de entrada 'novo nome de perfil'](media/modulo1/user-profiles-3.png "caixa de entrada 'novo nome de perfil'")
