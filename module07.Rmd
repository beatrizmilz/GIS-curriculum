...
## Criando uma nova camada GeoPackage ou Shapefile
...
![Diálogo da nova camada do shapefile](media/modulo7/new-shapefile-dialog.png "Diálogo da nova camada do shapefile")
...
## Digitalizando uma camada existente
...
![Nova caixa de diálogo GeoPackage](media/modulo7/new-vector.png "Nova caixa de diálogo GeoPackage")
...
![caixa para selecionar feições](media/modulo7/select-feature.png "caixa para selecionar feições")
...
## Georreferenciando um mapa Topográfico
...
1. O que é digitalização em GIS?
...
2. Qual dos seguintes conjuntos de dados auxiliares suportará a digitalização?
...
3. Quais fatores podem afetar a precisão dos dados durante a digitalização?
...
4. O que pode ser feito para melhorar a precisão?
...
5. Por que um modelo de dados é importante ao criar novos dados?
