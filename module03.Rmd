...
* Camadas vetoriais `br_rj_capital` e `br_rj_centro` no arquivo [module3.gpkg](data/module3/modulo3.gpkg).
...
#### **Tutorial/Exercício: Carregando dados OSM no QGIS usando o plugin QuickOSM**
...
## Os dados da camada de assentamentos de alta resolução (HRSL)
...
#### **Tutotial/Exercício: Carregando os dados HRSL no QGIS**
...
1. Carregue o arquivo raster **hrsl_rj_capital_populacao** no QGIS.O arquivo se encontra na pasta do projeto no Github, no caminho data/module3)
