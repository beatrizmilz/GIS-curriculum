...
* Camada do limite administrativo do Rio de Janeiro (dentro de [module4.gpkg](data/module4/module4.gpkg))
* Clínicas do Rio de Janeiro (dentro de [module4.gpkg](data/module4/module4.gpkg))
* [Camada de assentamentos de alta resolução do Rio de Janeiro](data/module4/hrsl_rj_capital_populacao.tif )
...
![Painel de estilo de camada](media/modulo4/layer-styling.png "Painel de estilo de camada")
...
![Guias de estilo para dados vetoriais](media/modulo4/style-vector.png "Guias de simbologia para dados vetoriais")

![Guias de estilo para dados raster](media/modulo4/style-raster.png "Guias de simbologia para dados raster")
...
## Raster básico e simbologia vetorial
...
### **Tutorial/Exercício: Renderização vetorial**
...
### **Tutorial/Exercicio: Renderização raster**
...
1. O que é simbologia de camada?
    ...
    a. elemento gráfico representado como um marcador, traço ou preenchimento
...
2. Quais dos tipos de renderização abaixo são aplicáveis para dados vetoriais?
    a. renderizador de símbolo único
...
3. Quais são os tipos de renderização raster?
    ...
    a. pseudocolor de banda única
    b. cinza de banda única
    c. paletted
    d. cor multibanda


## Modos de mesclagem e efeitos de desenho
...
## Substituições definidas por dados e geradores de geometria
