...
## Introdução suave a conceitos de GIS
...
![True Size Of](media/modulo0/true-size-of.png "O verdadeiro tamanho dos países")
...
<table>
   <tr>
    <td>
         <img src="_bookdown_files/_main_files/figure-html/media/modulo0/blue-marble.jpg">
    ...
    <td>
         <img src="_bookdown_files/_main_files/figure-html/media/modulo0/globe.jpg">
...
![A terra como uma laranja](media/modulo0/dalandan.png "A terra como uma laranja")
...
![Projeção conforme](media/modulo0/conformal.png "Projeção conforme")
...
![Projeção equivalente](media/modulo0/authalic.png "Projeção equivalente")

Figura 4. Projeção equivalente com seu índice de Tissot. Os círculos tornam-se elipses, mas suas áreas permanecem as mesmas.


![Projeção equidistante](media/modulo0/equidistant.png "Projeção equidistante")
...
![Projeção azimutal equidistante](media/modulo0/az-equidistant.png "Projeção azimutal equidistante")
...
![Cilindro como uma superfície desenvolvível](media/modulo0/cylinder.png "Cilindro como uma superfície desenvolvível")
...
![Cone como superfície desenvolvível](media/modulo0/cone.png "Cone como superfície desenvolvível")

Figura 8. As projeções cônicas têm meridianos retos indo para um ponto nos pólos. Os paralelos são arcos.


![Plano como superfície desenvolvível](media/modulo0/plane.png "Plano como superfície desenvolvível")
...
![Aspectos de uma projeção cartográfica](media/modulo0/aspects.png "Aspectos de uma projeção cartográfica")
...
![Modelo de dados espaciais](media/modulo0/spatial-model.png "Modelo de dados espaciais")
...
![Modelo de dados raster](media/modulo0/raster.png "Modelo de dados raster")
...
![Modelo de dados vetoriais](media/modulo0/vector.png "Modelo de dados vetoriais")
...
![Stack de aplicativos de software livre e de código aberto para geoespaciais (FOSS4G)](media/modulo0/foss4g-stack.jpeg "Stack de aplicativos de software livre e de código aberto para geoespaciais (FOSS4G)")
...
![Mapa de Bogotá, Colômbia no estilo Noite Estrelada](media/modulo1/sample-1.jpg "Mapa de Bogotá, Columbia no estilo Noite Estrelada")
...
![Dados de rastreamento de tempestade entre 1851 a 2020](media/modulo1/sample-2.jpg "Dados de rastreamento de tempestade entre 1851 a 2020")
...
![Mapa da Ilha Kerguelen](media/modulo1/sample-3.jpg "Mapa da Ilha Kerguelen")
...
![Tentativas de arremessos de quadra e pontos marcados na temporada 81 do UAAP](media/modulo1/sample-4.jpg "Tentativas de field goal e pontos marcados na temporada 81 do UAAP")
...
![QGIS Map Showcase](media/modulo1/qgis-map-showcase.png "QGIS Map Showcase")
...
![A interface QGIS](media/modulo1/qgis-interface.png "A interface QGIS")
...
![Partes da interface QGIS](media/modulo1/qgis-interface-parts.png "Partes da interface QGIS")
...
![Interface QGIS com algumas personalizações](media/modulo1/qgis-interface-custom.png "Interface QGIS com algumas personalizações")
...
![Abra o QGIS e clique no menu Exibir](media/modulo1/ex01-01.png "Abra o QGIS e clique no menu Visão")

3. Observe o menu **Painéis**

![Observe o menu Painéis](media/modulo1/ex01-02.png "Observe o menu Painéis")

4. Observe o menu **Barras de ferramentas**

![Observe o menu Barras de ferramentas](media/modulo1/ex01-03.png "Observe o menu Barras de ferramentas")
...
![Menu Gerenciar e Instalar Complementos](media/modulo1/plugins-menu.png "Menu Gerenciar e Instalar Complementos")
...
![Caixa de diálogo Gerenciar e instalar complementos](media/modulo1/manage-and-install-plugins-dialog.png "Caixa de diálogo Gerenciar e instalar complementos")
...
![Abrir caixa de diálogo Gerenciar e instalar complementos](media/modulo1/plugins-menu-2.png "Abrir caixa de diálogo Gerenciar e instalar complementos")
...
![Instalar o plugin Memory Layer Saver](media/modulo1/memory-layer-saver-plugin.png "Instalar o plugin Memory Layer Saver")

   - QuickOSM

![Instalar plugin QuickOSM](media/modulo1/quickosm-plugin.png "Instalar plugin QuickOSM")
...
![As Configurações do Sistema](media/modulo1/settings-1.png "As Configurações do Sistema")

Figura 1.7. As configurações do sistema


![Configurações do projeto](media/modulo1/settings-2.png "Configurações do projeto")
...
![Configurações gerais do QGIS](media/modulo1/change-theme.png "Configurações gerais do QGIS")
...
![Acessando perfis de usuário](media/modulo1/user-profiles-1.png "Acessando perfis de usuário")
...
![alt_text](media/modulo1/user-profiles-2.png "image_tooltip")


2. Dê um nome ao seu novo perfil de usuário.

![alt_text](media/modulo1/user-profiles-3.png "image_tooltip")
...
![Análise de múltiplas camadas em GIS](media/modulo2/spatial-layers.jpg "Análise de múltiplas camadas em GIS")
...
![O painel do navegador QGIS](media/modulo2/qgis-browser-1.png "O painel do navegador QGIS")
...
5. Verifique os arquivos dentro da pasta (Figura 2.3). Existem vários deles. A partir da própria árvore de arquivos, já podemos ter uma ideia dos arquivos e camadas que podemos carregar no QGIS. Os ícones à esquerda dos nomes indicam se os dados são um vetor ![Símbolo vetorial](media/modulo2/symbol-vector.png "Símbolo vetorial"), um raster ![Símbolo raster](media/modulo2/symbol-raster.png "Símbolo raster"), um banco de dados ![Símbolo do banco de dados](media/modulo2/symbol-db.png" Símbolo do banco de dados") ou dados tabulares simples ![Símbolo da tabela](media/modulo2/symbol-table.png "Símbolo da tabela").


![Arquivos do módulo 2 no painel do navegador](media/modulo2/qgis-browser-2.png "Arquivos do módulo 2 no painel do navegador")
...
![Verificando as propriedades da camada](media/modulo2/qgis-browser-3.png "Verificando as propriedades da camada")

Figura 2.4 Verificando as propriedades da camada

![Propriedades da camada no painel do navegador](media/modulo2/qgis-browser-layer-properties.png "Camada Propriedades do painel do navegador")
...
![As camadas vetoriais carregadas no QGIS](media/modulo2/vector-layers-loaded-1.png "As camadas vetoriais carregadas no QGIS")
...
![Painel de camadas](media/modulo2/layers-panel-1.png "Painel de camadas")
...
![A caixa de diálogo Propriedades da camada](media/modulo2/layer-properties.png "A caixa de diálogo Propriedades da camada")
...
![Propriedades de informações da camada br_pais](media/modulo2/metadata-1.png "Propriedades de informações da camada br_pais")
...
![Editando alguns metadados](media/modulo2/metadata-2.png "Editando alguns metadados")

Figura 2.10. Editando alguns metadados

4. Vá para a guia Informações novamente e veja se algo mudou.

![A guia Informações após a edição de alguns metadados](media/modulo2/metadata-3.png "A guia Informações após a edição de alguns metadados")
...
![Gerenciador de fonte de dados](media/modulo2/data-source-manager-1.png "Gerenciador de fonte de dados")
...
![Carregando um vetor dentro de um GeoPackage](media/modulo2/data-source-manager-vector.png "Carregando um vetor dentro de um GeoPackage")
...
3. **Carregando Rasters**
    ...
    1. Para carregar um raster, vá para a aba Raster. Arquivos e arquivos remotos podem ser carregados por meio de um protocolo como HTTP, nuvem, etc. Há um raster (br_rj_srtm_dem) dentro do geopackage br_rj. Este raster é um modelo digital de elevação da região da cidade do Rio de Janeiro. Para carregá-lo:
        ...
        1. Tipo de fonte: Arquivo
        2. Fonte: Selecione o geopackage br_rj usando o botão pesquisar ![Botão pesquisar](media/modulo2/data-source-manager-search.png "Botão pesquisar")
        3. Clique em Adicionar
        4. Se há mais de 1 arquivo raster dentro do geopackage, o QGIS irá pedir para você selecionar quais carregar

![Carregando um raster dentro de um GeoPackage](media/modulo2/data-source-manager-raster.png "Carregando um raster dentro de um GeoPackage" )
...
4. **Carregando CSV e outros arquivos de texto delimitado**
    ...
    4. Há um arquivo CSV na pasta de dados denominado br_rj_escolas.csv que contém as localizações das escolas no Rio de Janeiro. Para carregá-lo:
        ...
        2. Nome do arquivo: Selecione o br_rj_escolas CSV usando o botão pesquisar ![Botão pesquisar](media/modulo2/data-source-manager-search.png "Botão pesquisar")
...
![Carregando um arquivo CSV](media/modulo2/data-source-manager-csv.png "Carregando um arquivo CSV")
...
![Painel de camadas com todas as camadas carregadas](media/modulo2/layers-panel-2.png "Painel de camadas com todas as camadas carregadas")
...
![Interface QGIS com todas as camadas carregadas](media/modulo2/map-canvas-1.png "Interface QGIS com todas as camadas carregadas")
...
![Adicionando uma conexão XYZ no QGIS](media/modulo2/xyz-1.png "Adicionando uma conexão XYZ no QGIS")
...
![Servidor ESRI World Imagery Tile adicionado ao Painel do Navegador](media/modulo2/xyz-2.png "Servidor ESRI World Imagery Tile adicionado ao Painel do Navegador")
...
![Camada do mapa base OpenStreetMap carregada no QGIS](media/modulo2/xyz-3.png "Camada do mapa base OpenStreetMap carregada no QGIS")
...
![Criando uma nova conexão WMS/WMTS](media/modulo2/wms-1.png "Criando uma nova conexão WMS/WMTS")
...
![O LiPAD 100-year Flood Hazard WMS adicionado ao painel do navegador](media/modulo2/wms-2.png "O LiPAD 100-year Flood Hazard WMS adicionado ao painel do navegador")
...
![Mapa de risco de inundação do WMS carregado no QGIS](media/modulo2/wms-3.png "Mapa de risco de inundação do WMS carregado no QGIS")
...
![Exportando uma camada do QGIS](media/modulo2/exporting-layers.png "Exportando uma camada do QGIS")
...
![Caixa de diálogo Salvar camada vetorial](media/modulo2/save-vector.png "Caixa de diálogo Salvar camada vetorial")
...
É claro que você também pode tornar a camada temporária permanente, exportando a camada para um arquivo. Ao clicar no ícone ![Símbolo de camada temporária](media/modulo2/symbol-temp.png "Símbolo de camada temporária") você abrirá automaticamente uma caixa de diálogo de exportação de camada.
...
![Conectar ao GeoNode](media/modulo2/connect-geonode.png "Conectar ao GeoNode")
...
3. Crie uma nova camada de geopackage com ![Criar novo símbolo de geopakage](media/modulo2/symbol-gpkg.png "Criar novo símbolo de geopakage") na barra de ferramentas do Gerenciador de fonte de dados. Nomeie-o como `arvores`, adicione campos de raio (número inteiro) e espécies (texto) e use um CRS projetado (por exemplo, EPSG: 3857)

![Nova camada GeoPackage](media/modulo2/virtual-1.png "Nova camada GeoPackage")

Quando for avisado de que o arquivo já existe, selecione Adicionar nova camada.

![GeoPackage Layer já existe](media/modulo2/virtual-2.png "GeoPackage Layer já existe")
...
![Adicionar novas árvores](media/modulo2/virtual-3.png "Adicionar novas árvores")

8. Depois de adicionar os pontos, não se esqueça de salvar suas edições clicando em ![Salvar símbolo de edições](media/modulo2/symbol-save-edits.png "Salvar símbolo de edições") na barra de ferramentas Digitalização antes de desligar a Edição.

![Novos pontos (árvores) adicionados](media/modulo2/virtual-4.png "Novos pontos (árvores) adicionados]")

9. Adicione uma camada virtual clicando em ![Adicionar símbolo de camada virtual](media/modulo2/symbol-virtual.png "Adicionar símbolo de camada virtual")
...
![Criar camada virtual](media/modulo2/virtual-5.png "Criar camada virtual")

![Camada virtual no QGIS](media/modulo2/virtual-6.png "Camada virtual no QGIS")
...
<!--chapter:end:02-modulo2.Rmd-->

# OpenStreetMap e a camada de assentamentos de alta resolução
...
![Site do OpenStreetMap](media/modulo3/osm.png "Site do OpenStreetMap")
...
![Camadas do Rio de Janeiro carregadas no QGIS](media/modulo3/quickosm-1.png "Camadas Rio de Janeiro carregadas no QGIS")
...
![Plugin QuickOSM](media/modulo3/quickosm-2.png "plugin QuickOSM")
...
![Carregar todas as estradas na extensão da camada br_rj_centro](media/modulo3/quickosm-3.png "Carregar todas as rodovias na extensão da camada br_rj_centro")
...
![Dados de estradas carregados do OSM](media/modulo3/quickosm-4.png "Dados de estradas carregados do OSM")
...
![A versão de consulta Overpass da consulta rápida para carregar rodovias](media/modulo3/quickosm-5.png "A versão de consulta Overpass da consulta rápida para carregar rodovias")
...
![Carregar amenidades (pontos) marcados como fast_food na extensão da camada `br_rj_capital`](media/modulo3/quickosm-6.png "Carregar amenidades (pontos) marcados como fast_food na extensão da camada `br_rj_capital`")
...
![Locais de fast food carregados do OSM](media/modulo3/quickosm-7.png "Locais de fast food carregados do OSM")
...
![Dados HRSL em HDX](media/modulo3/hdx.png "Dados HRSL em HDX")
...
![O HRSL para Rio de Janeiro, capital](media/modulo3/hrsl-1.png "O HRSL para Rio de Janeiro, capital")
...
![Parâmetros QuickOSM para carregar fast food no Rio de Janeiro](media/modulo3/quickosm-6.png "Parâmetros QuickOSM para carregar fast food no Rio de Janeiro")

Consulta rápida para carregar todas as comodidades marcadas como fast food

2. Clique em Mostrar consulta.

![Versão Overpass da consulta](media/modulo3/overpass-1.png "Versão Overpass da consulta")
...
![Consulta Overpass para carregar fast foods Subway](media/modulo3/overpass-2.png "Consulta Overpass para carregar fast foods Subway")
...
![Amenidades marcadas como fast food cujo nome é Subway carregado do OSM](media/modulo3/overpass-3.png "Amenidades marcadas como fast food cujo nome é Subway carregado do OSM")
...
![alt_text](media/modulo4/layer-styling.png "image_tooltip")
...
![alt_text](media/modulo4/style-vector.png "image_tooltip")

![alt_text](media/modulo4/style-raster.png "image_tooltip")
...
2. Adicione as duas camadas vetoriais ao QGIS; Clique no botão Adicionar camada vetorial ![alt_text](media/modulo4/add-vector.png "image_tooltip") ou use o painel do navegador.
...
![Renderização padrão](media/modulo4/default-vector-render.png "Renderização padrão")Renderização padrão
...
![Sem renderização de preenchimento para o polígono](media/modulo4/no-fill-render.png "Sem renderização de preenchimento para o polígono")
...
![Diálogo de Propriedades da Camada](media/modulo4/vector-style.png "Diálogo de Propriedades da Camada")

Figura 4.5: Diálogo de Propriedades da Camada

10. O mapa resultante deve ser o seguinte

![Renderização vetorial final](media/modulo4/final-vector-render.png "Renderização vetorial final")
...
![Menu de simbologia](media/modulo4/qgis9.png "Menu de simbologia")
...
![Densidade populacional da cidade do Rio de Janeiro](media/modulo4/hrsl-style.png "Densidade populacional da cidade do Rio de Janeiro")

Figura 4.8: Densidade populacional da cidade do Rio de Janeiro

5. Amplie para ver o novo mapa em maior detalhe

![Mapa ampliado](media/modulo4/zoom-in.png "Mapa ampliado")
...
![A área de trabalho inicial esperada](media/modulo4/initial-workspace.png "A área de trabalho inicial esperada")
...
Na parte inferior do menu Simbologia, há uma caixa de seleção para efeitos do Desenho. Vamos habilitar isso e, em seguida, clicar no botão personalizar efeitos ![Alt_text](media/modulo4/customise-effects-button.png "image_tooltip") à sua direita:

![Janela Propriedades da camada e menu de simbologia](media/modulo4/draw-effects.png "Janela Propriedades da camada e menu Simbologia")

Figura 4.11: Janela Propriedades da camada e menu Simbologia

3. Uma nova caixa de diálogo Propriedades de efeitos é aberta

![Caixa de diálogo Propriedades de efeitos](media/modulo4/new-effects-dialog.png "caixa de diálogo Propriedades de efeitos")
...
![Selecione o tipo de efeito como desfoque](media/modulo4/blur-effect.png "Selecione o tipo de efeito como desfoque")
...
![Camada desfocada](media/modulo4/blurry-result.png "Camada desfocada")
...
![Diálogo de propriedades de efeitos](media/modulo4/drop-shadow.png "Diálogo de propriedades de efeitos")
...
![Efeito de sombra projetada](media/modulo4/drop-shadow-result.png "Efeito de sombra projetada")
...
![Operação centróide na camada limite administrativa](media/modulo4/centroid.png "Operação centróide na camada limite administrativa")
...
* Trabalhando com a Tabela de Atributos - [https://docs.qgis.org/3.16/en/docs/user_manual/working_with_vector/attribute_table.html?highlight=layer%20attributes](https://docs.qgis.org/3.16/en/docs/user_manual/working_with_vector/attribute_table.html?highlight=layer%20attributes)
...
![Planimetric](media/modulo6/gen-settings.png "Planimetric")

Figura 6.4: Configurações gerais

5. Em seguida, clique no botão **Abrir calculadora de campo** ![Alt_text](media/modulo6/field_calculator.png "image_tooltip") no botão da barra de ferramentas. A caixa de diálogo da calculadora de campo será aberta; preencha o nome do campo de saída, neste caso será 'area_km2'. Escolha o número decimal (real) no tipo de campo de saída. Altere a precisão para 2 casas decimais. Para calcular a área, use a seguinte expressão:
...
![Diálogo da calculadora de campo](media/modulo6/fieldcalc.png "Diálogo da calculadora de campo")
...
![Nova tabela de atributos com novos campos e atributos](media/modulo6/area.png "Nova tabela de atributos com novos campos e atributos")
...
![Adicionar camadas diferentes](media/modulo6/add-layers.png "Adicionar camadas diferentes")

Figura 6.7: Adicionar camadas diferentes

2. O a seleção será aplicada à camada Clínicas, portanto, abra a tabela de atributos da camada Clínica. Clique no botão selecionar recursos usando a expressão ![Alt_text](media/modulo6/select_features_button.png "image_tooltip") e digite a seguinte expressão no construtor de expressão;
...
![select](media/modulo6/select.png "select")
...
![alt_text](media/modulo6/selected-canvas.png "image_tooltip")

Figura 6.9: Clínica/recurso selecionado está destacado (amarelo)


![alt_text](media/modulo6/selected-attr.png "image_tooltip")
...
<!--chapter:end:06-modulo6.Rmd-->

# Criando e editando camadas
...
![Imagens de sensoriamento remoto de diferentes linhas costeiras](media/modulo7/rs-images.png "Imagens de sensoriamento remoto de diferentes linhas costeiras")
...
![Aqui, os edifícios foram digitalizados (rastreados) sobre uma foto aérea](media/modulo7/buildings.png "Aqui, os edifícios foram digitalizados (rastreados) sobre uma foto aérea")
...
1. Para criar uma nova camada GeoPackage, pressione o botão Nova Camada GeoPackage ![Alt_text](media/modulo7/geopackage-button.png "image_tooltip")
...
![Diálogo de nova camada GeoPackage](media/modulo7/new-geopackage-dialog.png "Diálogo de nova camada GeoPackage")

Figura 7.3: Diálogo de nova camada GeoPackage

2. O primeiro passo é indicar a localização do arquivo de banco de dados. Isso pode ser feito pressionando o botão ![Alt_text](media/modulo7/database-file-location.png "image_tooltip") à direita do campo Banco de dados e selecionando um arquivo GeoPackage existente ou criando um novo. O QGIS adicionará automaticamente a extensão correta ao nome que você fornecer.
...
5. Especifique o sistema de referência de coordenadas usando o botão ![Alt_text](media/modulo7/mActionSetProjection.png "image_tooltip")
...
6. Para adicionar campos à camada que você está criando:
    ...
    5. Clique no botão Adicionar à lista de campos ![Alt_text](media/modulo7/mActionNewAttribute.png "image_tooltip")
...
1. Para criar uma nova camada de formato ESRI Shapefile, pressione ![Alt_text](media/modulo7/mActionNewVectorLayer.png "image_tooltip") Novo botão Shapefile Layer… no menu Camada ‣ Criar Nova Camada ‣ ou na barra de ferramentas Data Source Manager. A caixa de diálogo Nova Camada Shapefile será exibida conforme mostrado na Figura 7.4.

![alt_text](media/modulo7/new-shapefile-dialog.png "image_tooltip")
...
6. Especifique o sistema de referência de coordenadas usando o botão ![Alt_text](media/modulo7/mActionSetProjection.png "image_tooltip"); você pode selecionar o WGS 84 universal que é adequado para projetos de mapeamento web em todo o mundo
...
7. Para adicionar campos à camada que você está criando:
    ...
    4. Clique no botão Adicionar campos à lista ![Alt_text](media/modulo7/mActionNewAttribute.png "image_tooltip")
...
2. Crie um novo projeto no QGIS clicando no ícone _Novo Projeto_ ![Alt_text](media/modulo7/new-project.png "image_tooltip").
3. Vá para _Camada ‣ Criar camada ‣ Nova camada GeoPackage_. Crie uma camada como a da imagem a seguir:

![Alt_text](media/modulo7/new-vector.png "image_tooltip")
...
![ESRI World Imagery encontrado no painel do navegador](media/modulo7/xyz-2.png "ESRI World Imagery encontrado no painel do navegador")

![ESRI World Imagery carregado no QGIS](media/modulo7/xyz-3.png "ESRI World Imagery carregado no QGIS ")
...
![Camada ESRI World Imagery ampliada](media/modulo7/digitize-zoom.png "ESRI World Imagery layer ampliada")
...
8. Clique no botão _Alternar Edição_ ![alt_text](media/modulo7/edit-layer.png "image_tooltip").
...
![Ferramentas de digitalização](media/modulo7/digi-toolbar.png "Ferramentas de digitalização")
...
11. Clique no botão _Adicionar feição_ ![Alt_text](media/modulo7/add-feature.png "image_tooltip") para iniciar a digitalização. Vamos digitalizar os edifícios
...
![Digitalizando novo recurso](media/modulo7/digitize-1.png "Digitalizando novo recurso")

Figura 7.8.1: Digitalizando novo recurso

![Preencha os valores de atributo](media/modulo7/digitize-2.png "Preencha os valores dos atributos")
...
![Novo recurso criado](media/modulo7/digitize-3.png "Novo recurso criado")
...
![Alt_text](media/modulo7/select-feature.png "image_tooltip")
...
<table>
  <tr>
   <td>
<img src="media/modulo7/image186.png" width="" alt="alt_text" title="image_tooltip">
   </td>
...
<img src="media/modulo7/image187.png" width="" alt="alt_text" title="image_tooltip">
...
<img src="media/modulo7/image188.png" largura="" alt="alt_text" title="image_tooltip">
...
2. Clique no botão Adicionar raster ![Adicionar Raster](media/modulo7/add-raster.png "Adicionar Raster") para adicionar o arquivo de imagem do mapa, [Mapa Topográfico de Pampanga](media/modulo7/manhumirim_mg_es.jpeg), como imagem a georreferenciar. O mapa topográfico será adicionado à tela do georreferenciador. Agora você pode ampliar para ler os detalhes do mapa. Uma maneira de fazer isso é lendo os metadados e as informações de legenda na parte inferior e, em seguida, relacionando-os com os recursos no mapa.

![Mapa na tela do Georeferenciador](media/modulo7/georeferencer.png "Mapa na tela do Georeferenciador")
...
3. Abra Configurações ► Configurações de transformação ou clique em Transformação Botão de configurações![Alt_text](media/modulo7/georef-settings-btn.png "image_tooltip").
4. Clique no ícone ![Alt_text](media/modulo7/dots.png "image_tooltip") próximo à caixa Raster de saída, vá para a pasta e crie a pasta 'dados pampanga' e nomeie o arquivo como pampanga_georef.tif.
5. Defina o resto dos parâmetros conforme mostrado abaixo

![Parâmetros de transformação](media/modulo7/transformation-settings.png "Parâmetros de transformação")
...
9. Clique no botão Adicionar ponto![Adicionar ponto](media/modulo7/add-point.png "Adicionar ponto") e clique na interseção do canto inferior esquerdo do mapa.
...
![Selecionar GCP](media/modulo7/georef-1.png "Selecionar GCP")

Figura 7.11.1: Insira as coordenadas do mapa

![Insira as coordenadas do mapa](media/modulo7/georef-2.png "Insira as coordenadas do mapa")
...
![Primeira coordenada para o georreferenciamento](media/modulo7/georef-3.png "Primeira coordenada para o georreferenciamento")
...
15. Finalmente, georreferencie seu mapa com **Arquivo ► Iniciar georreferenciamento** ou o botão Iniciar Georreferenciamento ![Botão Iniciar Georreferenciamento](media/modulo7/georef-start-btn.png "botão Iniciar Georreferenciamento").

![GCPs adicionados](media/modulo7/georef-4.png "GCPs adicionados")

Figura 7.13: GCPs adicionados

![Mapa georreferenciado carregado no QGIS](media/modulo7/georef-5.png "Mapa georreferenciado carregado no QGIS")
...
![Indo do ponto A ao B usando o Openstreetmap](media/modulo8/fig81.png "Indo do ponto A ao B usando o Openstreetmap")
...
![Linhas de vetor representando ruas e a tabela de atributos associada](media/modulo8/fig82.png "Linhas de vetor representando ruas e a tabela de atributos associada ")
...
![dados vetoriais com tabela de atributos](media/modulo8/fig83.png "dados vetoriais com tabela de atributos")
...
![Elementos de uma operação de geoprocessamento](media/modulo8/fig84.png "elementos de uma operação de geoprocessamento")
...
![Conjuntos de dados vetoriais carregados: pontos, linha e polígonos](media/modulo8/fig85.png "Conjuntos de dados vetoriais carregados: pontos, linha e polígonos")
...
![Especificações do sistema de referência de coordenadas usado no projeto QGIS](media/modulo8/fig86.png "Especificações do sistema de referência de coordenadas usado no projeto QGIS")
...
![Estatísticas básicas para campos](media/modulo8/fig87.png "Estatísticas básicas para campos")
...
![Preparando para executar estatísticas básicas para camada de estradas](media/modulo8/fig88.png "Preparando para executar estatísticas básicas para camada de estradas")
...
![Painel de verificação de topologia](media/modulo8/fig89_a.png "Painel de verificação de topologia")


![Janela de verificação de topologia](media/modulo8/fig89_b.png "Janela de verificação de topologia")
...
![Janela de configurações de regras de topologia](media/modulo8/fig810.png "Janela de configurações de regras de topologia")
...
![Menu suspenso de regras de topologia com base na camada selecionada](media/modulo8/fig811.png "Menu suspenso de regras de topologia com base na camada selecionada")
...
![Regras de topologia a serem definidas](media/modulo8/fig812.png "Regras de topologia a serem definidas")
...
![Resultados da verificação de topologia](media/modulo8/fig813.png "Resultados da verificação de topologia")
...
![Erro de ponto duplicado na camada do vetor de pontos de interesse](media/modulo8/fig814.png "Erro de ponto duplicado na camada do vetor de pontos de interesse")
...
![Excluir geometrias duplicadas nos pontos de interesse da camada](media/modulo8/fig815.png "Excluir geometrias duplicadas nos pontos de interesse da camada")
...
![Resultado da execução da exclusão de geometrias duplicadas](media/modulo8/fig816.png "Resultado da execução da exclusão de geometrias duplicadas")
...
![Verificação de topologia na camada vetorial de edifícios](media/modulo8/fig817_a.png "Verificação de topologia na camada vetorial de edifícios")
...
![Resultados da verificação de topologia na camada vetorial de edifícios](media/modulo8/fig817_b.png "Resultados da verificação de topologia na camada vetorial de edifícios")
...
![Listar valores únicos em uma funcionalidade de camada vetorial](media/modulo8/fig819_a.png "Listar valores únicos em uma funcionalidade de camada vetorial")
...
![Lista valores exclusivos em uma funcionalidade de camada vetorial (Processamento em lote)](media/modulo8/fig819_b.png "Lista valores exclusivos em uma funcionalidade de camada vetorial (Processamento em lote)")
...
![Plugin Group Stats](media/modulo8/fig820_a.png "plugin Group Stats")
...
![Janela Group Stats](media/modulo8/fig820_b.png "Janela Group Stats")
...
![Executando Group Stats na camada de construção](media/modulo8/fig821.png "Executando Group Stats na camada de construção")
...
![Executando Group Stats na camada de estradas](media/modulo8/fig822.png "Executando Group Stats na camada de estradas")
...
![Definindo os parâmetros para um buffer de 500 m ao redor dos locais de culto](media/modulo8/fig823.png "Definindo os parâmetros para um buffer de 500 m ao redor dos locais de culto")
...
![Buffer de execução em uma camada vetorial de ponto](media/modulo8/fig824.png "Running buffer on a point vector layer")
...
![Calcule a área para a camada recém-obtida e, em seguida, calcule usando Group Stats a soma total](media/modulo8/fig825.png "Buffer de execução em Calcule a área para a camada recém-obtida, então calcule usando Group Stats a soma total da camada vetorial")
...
![Figura 8.26a - Selecione landuse fclass = industrial](media/modulo8/fig826_a.png "Figura 8.26a - Selecione landuse fclass = industrial")

Figura 8.26a - Selecione landuse fclass = industrial.


![Seleção reduzida de alguns edifícios e uso do solo industrial, para que o cálculo possa terminar mais rápido](media/modulo8/fig826_b.png "Seleção reduzida de alguns edifícios e uso do solo industrial, para que o cálculo possa terminar mais rápido")
...
![Executando o algoritmo de Clip](media/modulo8/fig827_a.png "Executando o algoritmo de Clip")
...
![Resultados da funcionalidade do clipe](media/modulo8/fig827_b.png "Resultados da funcionalidade do clipe")
...
![Filtrando a camada de poi para obter todas as escolas](media/modulo8/fig828_a.png "Filtrando a camada de poi para obter todas as escolas")

Figura 8.28a - Filtrando a camada de poi para obter todas as escolas


![Todas as escolas na camada de poi](media/modulo8/fig828_b.png "Todas as escolas na camada de poi")

Figura 8.28b - Todas as escolas na camada de poi


![Executando o algoritmo do polígono de Voronoi](media/modulo8/fig828_c.png "Executando o algoritmo do polígono de Voronoi")

Figura 8.28c - Executando o algoritmo do polígono de Voronoi


![Resultados da aplicação do algoritmo de polígonos de Thiessen (Voronoi) a uma camada de vetor de ponto](media/modulo8/fig828_d.png "Resultados da aplicação do algoritmo de polígonos de Thiessen (Voronoi) a uma camada de vetor de ponto")
...
![Criando uma grade vetorial de 2X2km para o Recife](media/modulo8/fig829_a.png "Criando uma grade vetorial 2X2km para Recife")
...
![Grade vetorial de 2X2km para a província de Recife](media/modulo8/fig829_b.png "Grade vetorial de 2X2km para a província de Recife")
...
![Filtrando áreas verdes e espaços construídos em Recife](media/modulo8/fig830_a.png "Filtrando áreas verdes e espaços construídos em Recife")

Figura 8.30a - Filtragem de áreas verdes e espaços construídos em Recife


![Distribuição espacial das áreas verdes e áreas construídas em Recife](media/modulo8/fig830_b.png "Distribuição espacial das áreas verdes e áreas construídas em Recife")
...
![Parâmetros para o algoritmo de interseção](media/modulo8/fig831.png "Parâmetros para o algoritmo de interseção")

Figura 8.31 - Parâmetros para o algoritmo de interseção

O resultado deve ser semelhante ao da figura 8.32.

![Resultado da execução do algoritmo de interseção para prender os polígonos vetoriais de uso do solo à camada da grade](media/modulo8/fig832.png "Resultado da execução do algoritmo de interseção para prender os polígonos vetoriais do uso do solo à camada da grade")
...
![Recursos Landuse cortados por cada célula da grade e sua tabela de atributos associada](media/modulo8/fig833.png "Recursos Landuse cortados por cada célula da grade e sua tabela de atributos associada")
...
![Selecionando os espaços verdes](media/modulo8/fig834_a.png "Selecionando os espaços verdes")

Figura 8.34a - Seleção dos espaços verdes.


![Espaços verdes selecionados](media/modulo8/fig834_b.png "Espaços verdes selecionados")

Figura 8.34b - Espaços verdes selecionados.


![Espaços verdes e construídos](media/modulo8/fig834_c.png "Espaços verdes e construídos")
...
![Calculando a área de cada recurso](media/modulo8/fig834_d.png "Calculando a área de cada recurso")

Figura 8.34d - Calculando a área de cada recurso.

![Configuração de parâmetros GroupStat para somar as áreas verdes por cada célula de grade de 2X2km](media/modulo8/fig834_e.png "Configuração de parâmetros GroupStat para somar as áreas verdes por cada célula de grade 2X2km")
...
![Carregando espacos_verdes_grade CSV](media/modulo8/fig835_a.png "Carregando espacos_verdes_grade CSV")

Figura 8.35a - Carregando o CSV espacos_verdes_grade


![A tabela de atributos CSV espacos_verdes_grade](media/modulo8/fig835_b.png "A tabela de atributos CSV espacos_verdes_grade")
...
Na janela **Uniões**, pressione o botão verde mais abaixo![Botão Adicionar camada de junção](media/modulo8/add_join_btn.png "botão Adicionar camada de junção") e defina os parâmetros como na figura 8.35, para espaços verdes.


![Configurando os parâmetros para unir pelo campo comum grid_id/id as somas dos espaços verdes e construídos para cada célula da grade - unidade de 2X2km](media/modulo8/fig835_c.png "Configurando os parâmetros para unir pelo campo comum grid_id/id as somas de espaços verdes e construídos para cada célula da grade - unidade de 2X2km ")
...
![CSV verde e incorporado unido à grade](media/modulo8/fig836_a.png "CSV verde e incorporado unido à grade")

Figura 8.36a - CSV verde e construído unido à grade.


![Tabela de atributos da camada vetorial Grade contendo as áreas totais para espaços verdes e edificados](media/modulo8/fig836_b.png "Tabela de atributos da camada vetorial Grade contendo as áreas totais para espaços verdes e edificados")
...
![Porcentagem de área verde na grade de 2kmX2km](media/modulo8/fig837_a.png "Porcentagem de área verde na grade de 2kmX2km")

Figura 8.37a - Porcentagem de área verde na grade de 2km X 2km


![Porcentagem calculada de área verde e construída](media/modulo8/fig837_b.png "Porcentagem calculada de área verde e construída")

Figura 8.37b - Porcentagem calculada de área verde e construída


![Calculando para a proporção de áreas verdes e construídas](media/modulo8/fig837_c.png "Calculando para a proporção de áreas verdes e construídas")

Figura 8.37c - Computação para a proporção de áreas verdes e áreas construídas


![Proporção calculada de áreas verdes e edificadas](media/modulo8/fig837_d.png "Proporção calculada de áreas verdes e edificadas")

Figura 8.37d - Razão calculada de áreas verdes e construídas


![Proporção de áreas verdes e construídas na grade de 2kmX2km](media/modulo8/fig837_e.png "Proporção de áreas verdes e áreas construídas na grade de 2kmX2km")
...
![Parâmetros de Soma de Comprimento de Linha](media/modulo8/fig838_a.png "Parâmetros de Soma de Comprimento de Linha")

Figura 8.38a - Parâmetros de Somatórios de Comprimento de Linha


![Comprimentos de estradas e contagens por célula de grade](media/modulo8/fig838_b.png "Comprimento de estradas e contagens por célula de grade")

Figura 8.38b - Comprimentos de estradas e contagens por célula de grade


![Distribuição espacial de unidades de 2X2km com a maioria das estradas](media/modulo8/fig838_c.png "Distribuição espacial de unidades de 2X2km com a maioria das estradas")
...
![Distribuição espacial de unidades de 2X2km com a maioria dos cursos d'água](media/modulo8/fig839.png "Distribuição espacial de unidades de 2X2km com a maioria dos cursos d'água")
...
![Selecionando POIs públicos](media/modulo8/fig840_a.png "Selecionando POIs públicos")

Figura 8.40a - Seleção de POIs públicos


![POIS público selecionado](media/modulo8/fig840_b.png "POIS público selecionado")
...
![Contar POIS públicos em cada grade de 2km X 2km](media/modulo8/fig840_c.png "Contar POIS públicos em cada grade de 2km X 2km")

Figura 8.40c - Contagem de POIS públicos em cada grade de 2km X 2km


![Distribuição espacial da densidade de POIs públicos por unidade 2X2km](media/modulo8/fig840_d.png "Distribuição espacial da densidade de POIs públicos por unidade 2X2km")
...
![Métodos de interpolação disponíveis no QGIS](media/modulo8/fig841.png "Métodos de interpolação disponíveis no QGIS")
...
![Criando pontos aleatórios dentro de uma camada poligonal](media/modulo8/fig842.png "Criando pontos aleatórios dentro de uma camada poligonal")
...
![Camada de dados de ponto - criada aleatoriamente dentro de polígonos especificados](media/modulo8/fig843.png "Camada de dados de ponto - criada aleatoriamente dentro de polígonos especificados")
...
![Criando valores aleatórios dentro dos limites especificados](media/modulo8/fig844.png "Criando valores aleatórios dentro dos limites especificados")
...
![Dados fictícios de precipitação para 93 estações meteorologia fictícias no Recife](media/modulo8/fig845.png "Dados fictícios de precipitação para 93 estações meteorológicas fictícias no Recife")
...
![Configurando a janela de processamento em lote para interpolar os valores de precipitação para todos os 7 dias](media/modulo8/fig846.png "Configurando a janela de processamento em lote para interpolar os valores de precipitação para todos os 7 dias")
...
![Conjuntos de dados interpolados](media/modulo8/fig847.png "Conjuntos de dados interpolados")
...
![Configurando informações temporais para o conjunto de dados raster (1)](media/modulo8/fig848_a.png "Configurando informações temporais para o conjunto de dados raster (1)")


![Configurando informações temporais para o conjunto de dados raster (2)](media/modulo8/fig848_b.png "Configurando informações temporais para o conjunto de dados raster (2)")


![Configurando informações temporais para o conjunto de dados raster (7)](media/modulo8/fig848_c.png "Configurando informações temporais para o conjunto de dados raster (7)")
...
![Defina os parâmetros do Painel de controle de tempo](media/modulo8/fig849.png "Defina os parâmetros do Painel de controle de tempo")

Figura 8.49 - Definir os parâmetros do painel do controlador de tempo.

Clique no botão Reproduzir![Botão Reproduzir](media/modulo8/play-btn.png "Botão Reproduzir") e veja como os valores mudam. Você pode escolher quais outras camadas ficarão visíveis. Na figura 8.50, adicionamos a camada vetorial de edifícios.


![Selecionando outras camadas para serem visíveis na animação temporal](media/modulo8/fig850.png "Selecionando outras camadas para serem visíveis na animação temporal")
...
<!--chapter:end:08-modulo8.Rmd-->

# **Processamento e análise raster**
...
![Uma matriz de valores](media/modulo9/fig91.png "Uma matriz de valores")
...
![No lado esquerdo, os valores são atribuídos a centróides. À direita, os valores são atribuídos à área da célula da grade - o pixel.](media/modulo9/fig92.png "No lado esquerdo, os valores são atribuídos aos centróides. À direita, os valores são atribuídos à área da célula da grade - o pixel. ")
...
![Exemplo de um histograma, onde x é uma camada raster](media/modulo9/fig95.png "Exemplo de um histograma, onde x é uma camada raster")
...
Para organizar melhor suas camadas, agrupe-as por categoria, da seguinte maneira: para as 5 camadas raster de cobertura de terra, crie um grupo denominado Cobertura de Terra (Land Cover) (no Painel de Camadas, clique no botão Adicionar Grupo![Botão Adicionar Grupo](media/modulo9/add-group-btn.png "Botão Adicionar Grupo")). Para o modelo de superfície digital, crie um grupo denominado JAXA [^3] SRTM DEM.
...
![Conjuntos de dados raster carregados](media/modulo9/fig96.png "Conjuntos de dados raster carregados")
...
![Extraindo metadados básicos de uma camada raster](media/modulo9/fig97.png "Extraindo metadados básicos de uma camada raster")
...
![Reprojetar funcionalidade no QGIS](media/modulo9/fig98.png "Reprojetar funcionalidade no QGIS")
...
![Janela Warp (reprojetar) QGIS](media/modulo9/fig99_a.png "Janela Warp (reprojetar) QGIS")
...
![HRSL reprojetado](media/modulo9/fig99_b.png "HRSL reprojetado")
...
![Método de reamostragem - vizinho mais próximo](media/modulo9/fig910.png "Método de reamostragem - vizinho mais próximo")
...
![Método de reamostragem - bilinear](media/modulo9/fig911.png "Método de reamostragem - bilinear")
...
**Processamento em lote** é a capacidade de executar processos repetitivos sses de dados, com interação mínima do usuário. A maioria das funcionalidades do QGIS tem esta opção disponível e pode ser ativada na janela de processo clicando no botão **Executar processo em lote** ![Botão Executar processo em lote](media/modulo9/batch-btn.png "botão Executar processo em lote") e alternando para a guia Executar processo em lote (consulte a figura 9.12).


![Guia de processamento em lote em uma janela de funcionalidade QGIS](media/modulo9/fig912.png "Guia de processamento em lote em uma janela de funcionalidade QGIS")
...
![Processamento em lote para reprojetar os rasters de cobertura vegetal](media/modulo9/fig913_a.png "Processamento em lote para reprojetar os rasters de cobertura do solo")

Figura 9.13a - Processamento em lote para reprojetar os rasters de cobertura do solo


![Nomes de saída de preenchimento automático](media/modulo9/fig913_b.png "Nomes de saída de preenchimento automático")

Figura 9.13b - Nomes de saída de preenchimento automático


![Rasters de cobertura de terra reprojetada](media/modulo9/fig913_c.png "Rasters de cobertura de terra reprojetada")
...
![Encontrando a ferramenta de mesclagem GDAL na Caixa de Ferramentas de Processamento](media/modulo9/fig914.png "Encontrando a ferramenta de mesclagem GDAL na Caixa de Ferramentas de Processamento")
...
![Selecionando as camadas SRTM para mesclar](media/modulo9/fig915_a.png "Selecionando as camadas SRTM para mesclar")
...
![Mosaico de todos os arquivos DSM correspondentes à nossa região de trabalho](media/modulo9/fig915_c.png "Mosaico de todos os arquivos DSM correspondentes à nossa região de trabalho ")
...
![Reprojetar raster mesclado](media/modulo9/fig915_d.png "Reprojetar raster mesclado")
...
![Processo em lote para extrair informações em um arquivo HTML separado para várias camadas raster](media/modulo9/fig916.png "Processo em lote para extrair informações em um arquivo HTML separado para várias camadas raster")
...
![Janela de histograma](media/modulo9/fig917.png "Janela de histograma")
...
![Ampliando o histograma computado DSM_mosaic_31983](media/modulo9/fig918.png "Ampliando o histograma computado DSM_mosaic_31983")
...
![Selecionando os valores mínimo e máximo para reclassificar o raster](media/modulo9/fig919.png "Selecionando os valores mínimo e máximo para reclassificar o raster")
...
![The Value Tool Panel](media/modulo9/fig920.png "The Value Tool Panel")
...
![Ferramenta de valor carregado - destaque na primeira guia - Tabela](media/modulo9/fig921.png "Ferramenta de valor carregado - destaque na primeira guia - Tabela")
...
![Usando uma máscara vetorial para extrair os dados raster em uma região específica](media/modulo9/fig922.png "Usando uma máscara vetorial para extrair os dados raster em uma região específica")
...
![Processo em lote recortando todas as camadas raster necessárias pela geometria da cidade do Rio de Janeiro](media/modulo9/fig923.png "Processo em lote recortando todas as camadas raster necessárias pela geometria da cidade do Rio de Janeiro")
...
![Camadas raster cortadas pelo contorno da cidade do Rio de Janeiro](media/modulo9/fig924.png "Camadas raster cortadas pelo contorno da cidade do Rio de Janeiro")
...
![Representação Clipped_Reprojected_SRTM_DEM](media/modulo9/fig925.png "representação Clipped_Reprojected_SRTM_DEM")
...
![Abrindo a calculadora raster](media/modulo9/fig926_a.png "Abrindo a calculadora raster")

Figura 9.26a - Abrindo a calculadora raster


![Calculadora raster](media/modulo9/fig926_b.png "Calculadora raster")
...
![Inserindo uma fórmula na Calculadora Raster](media/modulo9/fig927.png "Inserindo uma fórmula na Calculadora Raster")
...
![Resultado da identificação de todos os valores de pixel que estão abaixo de 200 metros usando a Calculadora de Raster](media/modulo9/fig928.png "Resultado de identificar todos os valores de pixel que estão abaixo de 200 metros usando a Calculadora de Raster")
...
![Distribuição espacial de todos os pixels de valor 1, ou seja, com altitude inferior a 200 metros](media/modulo9/fig929.png "Distribuição espacial de todos os pixels de valor 1, ou seja, com altitude inferior a 200 metros")
...
![Usando calculadora raster para identificar classes de distribuição populacional com base na altitude de até 200m](media/modulo9/fig930.png "Usando calculadora raster para identificar classes de distribuição populacional com base na altitude de até 200 m")
...
![Usando a Ferramenta de Valor para verificar os resultados da Calculadora de Raster](media/modulo9/fig931.png "Usando a Ferramenta de Valor para verificar os resultados da Calculadora de Raster")
...
![Distribuição da população que vive abaixo de 200m na ​​cidade do Rio de Janeiro, representada em uma resolução de 30m](media/modulo9/fig932.png "Distribuição da população que vive abaixo de 200m na ​​cidade do Rio de Janeiro, representada em uma resolução de 30m")
...
![Conversão de raster em vetor](media/modulo9/fig933_a.png "Conversão de raster em vetor")
...
![Parâmetros de conversão de varredura em vetor](media/modulo9/fig933_b.png "Parâmetros de conversão de varredura em vetor")
...
![Resultado da conversão de um conjunto de dados raster em um conjunto de dados vetorial](media/modulo9/fig934.png "Resultado da conversão de um conjunto de dados raster em um conjunto de dados vetorial")
...
![Identificando Estatísticas Zonais na Caixa de Ferramentas de Processamento](media/modulo9/fig935.png "Identificando Estatísticas Zonais na Caixa de Ferramentas de Processamento")
...
![Definindo os parâmetros para Estatísticas Zonais](media/modulo9/fig936.png "Definindo os parâmetros para Estatísticas Zonais")
...
![Camada vetorial resultante das estatísticas zonais](media/modulo9/fig937.png "Camada vetorial resultante das estatísticas zonais")
...
![alt_text](media/modulo9/fig938.png "image_tooltip")
...
![alt_text](media/modulo9/fig939.png "image_tooltip ")
...
![alt_text](media/modulo9/fig942.png "image_tooltip")
...
![alt_text](media/modulo9/fig943.png "image_tooltip")
...
![alt_text](media/modulo9/fig944.png "image_tooltip")
...
![alt_text](media/modulo9/fig945.png "image_tooltip")
...
![alt_text](media/modulo9/fig947.png "image_tooltip")
...
![alt_text](media/modulo9/fig948_a.png "image_tooltip")

![alt_text](media/modulo9/fig948_b.png "image_tooltip")

![alt_text](media/modulo9/fig948_c.png "image_tooltip")
...
![alt_text](media/modulo9/fig949.png "image_tooltip")
...
![alt_text](media/modulo9/fig950_a.png "image_tooltip")

Figura 9.50a - Poligonizando a camada raster LC2019_Mode (30m)


![alt_text](media/modulo9/fig950_b.png "image_tooltip")
...
![alt_text](media/modulo9/fig951.png "image_tooltip")
...
![alt_text](media/modulo9/fig952.png "image_tooltip")
...
![alt_text](media/modulo9/fig953_a.png "image_tooltip")

Figura 9.53a - Pixels raster para pontos


![alt_text](media/modulo9/fig953_b.png "image_tooltip")
...
![alt_text](media/modulo9/fig954.png "image_tooltip")
...
![alt_text](media/modulo9/fig955.png "image_tooltip")
...
![alt_text](media/modulo9/fig956.png "image_tooltip")
...
![alt_text](media/modulo9/fig957.png "image_tooltip")
...
![alt_text](media/modulo9/fig958.png "image_tooltip")
...
![alt_text](media/modulo9/fig959.png "image_tooltip")
...
![alt_text](media/modulo9/fig960.png "image_tooltip")
...
![alt_text](media/modulo9/fig961.png "image_tooltip")

Figura 9.61 - Parâmetros do algoritmo de associação de atributos por localização (resumo)


![alt_text](media/modulo9/fig962.png "image_tooltip")
...
![alt_text](media/modulo10/fig101.png "image_tooltip")

Figura 10.1 - Plugin oficial do gerenciador


![alt_text](media/modulo10/fig102_a.png "image_tooltip")

Figura 10.2a - Exibir plugins experimentais


![alt_text](media/modulo10/fig102_b.png "image_tooltip")
...
![alt_text](media/modulo10/fig103.png "image_tooltip")
...
![alt_text](media/modulo10/fig104.png "image_tooltip")
...
![alt_text](media/modulo10/fig105.png "image_tooltip")
...
![alt_text](media/modulo10/fig106_a.png "image_tooltip")

Figura 10.6a - Página inicial do plugin selecionado


![alt_text](media/modulo10/fig106_b.png "image_tooltip")
...
![alt_text](media/modulo10/fig107.png "image_tooltip")
...
![alt_text](media/modulo10/fig108.png "image_tooltip")
...
![Alt_text](media/modulo10/fig109_a.png "image_tooltip")
...
![alt_text](media/modulo10/fig109_b.png "image_tooltip")
...
![alt_text](media/modulo10/fig109_c.png "image_tooltip")
...
![alt_text](media/modulo10/fig109_d.png "image_tooltip")
...
![Alt_text](media/modulo10/fig1010_a.png "image_tooltip")
...
![alt_text](media/modulo10/fig1010_b.png "image_tooltip")
...
![alt_text](media/modulo10/fig1010_c.png "image_tooltip")
...
![Alt_text](media/modulo10/fig1011_a.png "image_tooltip")
...
![alt_text](media/modulo10/fig1011_b.png "image_tooltip")
...
![alt_text](media/modulo10/fig1011_c.png "image_tooltip")

Figura 10.11c - Usando o plugin Load Them All para carregar vários vetores


![alt_text](media/modulo10/fig1011_d.png "image_tooltip")
...
![Alt_text](media/modulo10/fig1012_a.png "image_tooltip")
...
![alt_text](media/modulo10/fig1012_b.png "image_tooltip")
...
![alt_text](media/modulo10/fig1012_c.png "image_tooltip")
...
![alt_text](media/modulo10/fig1012_d.png "image_tooltip")
...
![ALT_TEXT](media/modulo10/fig1013_a.png "image_tooltip")
...
![alt_text](media/modulo10/fig1013_b.png "image_tooltip")
...
![Alt_text](media/modulo10/fig1014_a.png "image_tooltip")
...
![alt_text](media/modulo10/fig1014_b.png "image_tooltip")
...
![alt_text](media/modulo10/fig1014_c.png "image_tooltip")
...
![alt_text](media/modulo10/fig1014_d.png "image_tooltip")
...
![Alt_text](media/modulo10/fig1015_a.png "image_tooltip")
...
![alt_text](media/modulo10/fig1015_b.png "image_tooltip")
...
![alt_text](media/modulo10/fig1015_c.png "image_tooltip")
...
![alt_text](media/modulo10/fig1015_d.png "image_tooltip")
...
![alt_text](media/modulo10/fig1015_e.png "image_tooltip")
...
![alt_text](media/modulo10/fig1015_f.png "image_tooltip")
...
![alt_text](media/modulo10/fig1015_g.png "image_tooltip")
...
![alt_text](media/modulo10/fig1015_h.png "image_tooltip")
...
![alt_text](media/modulo10/fig1015_i.png "image_tooltip")
...
![alt_text](media/modulo10/fig1015_j.png "image_tooltip")
...
![alt_text](media/modulo10/fig1015_k.png "image_tooltip")
...
![alt_text](media/modulo10/fig1015_l.png "image_tooltip")
...
![alt_text](media/modulo10/fig1015_m.png "image_tooltip")
...
![Alt_text](media/modulo10/fig1016_a1.png "image_tooltip")


![Alt_text](media/modulo10/fig1016_a2.png "image_tooltip")
...
![alt_text](media/modulo10/fig1016_b.png "image_tooltip")
...
![alt_text](media/modulo10/fig1016_c.png "image_tooltip")
...
![alt_text](media/modulo10/fig1016_d.png "image_tooltip")
...
![Alt_text](media/modulo10/fig1017_a.png "image_tooltip")
...
![alt_text](media/modulo10/fig1017_b.png "image_tooltip")
...
![alt_text](media/modulo10/fig1017_c.png "image_tooltip")
...
![alt_text](media/modulo10/fig1017_d.png "image_tooltip")
...
![alt_text](media/modulo10/fig1017_e.png "image_tooltip")
...
![alt_text](media/modulo10/fig1017_f.png "image_tooltip")
...
![alt_text](media/modulo10/fig1017_g.png "image_tooltip")
...
![Alt_text](media/modulo10/fig1018_a.png "image_tooltip")
...
![alt_text](media/modulo10/fig1018_b.png "image_tooltip")
...
![alt_text](media/modulo10/fig1018_c.png "image_tooltip")
...
![alt_text](media/modulo10/fig1018_d.png "image_tooltip")
...
![alt_text](media/modulo10/fig1018_e.png "image_tooltip")
...
![alt_text](media/modulo10/fig1018_f.png "image_tooltip")
...
![alt_text](media/modulo10/fig1018_g.png "image_tooltip")
...
![alt_text](media/modulo10/fig1018_h.png "image_tooltip")
...
![alt_text](media/modulo10/fig1018_i.png "image_tooltip")
...
![alt_text](media/modulo10/fig1018_j.png "image_tooltip")
