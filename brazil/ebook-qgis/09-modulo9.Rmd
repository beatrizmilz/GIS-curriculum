...
![Uma matriz de valores](_bookdown_files/_main_files/figure-html/media/modulo9/fig91.png "Uma matriz de valores")
...
![Exemplo de um histograma, onde x é uma camada raster](_bookdown_files/_main_files/figure-html/media/modulo9/fig95.png "Exemplo de um histograma, onde x é uma camada raster")
...
Para organizar melhor suas camadas, agrupe-as por categoria, da seguinte maneira: para as 5 camadas raster de cobertura de terra, crie um grupo denominado Cobertura de Terra (Land Cover) (no Painel de Camadas, clique no botão Adicionar Grupo![Botão Adicionar Grupo](_bookdown_files/_main_files/figure-html/media/modulo9/add-group-btn.png "Botão Adicionar Grupo")). Para o modelo de superfície digital, crie um grupo denominado SRTM DEM.
...
![Conjuntos de dados raster carregados](_bookdown_files/_main_files/figure-html/media/modulo9/fig96.png "Conjuntos de dados raster carregados")
...
![Extraindo metadados básicos de uma camada raster](_bookdown_files/_main_files/figure-html/media/modulo9/fig97.png "Extraindo metadados básicos de uma camada raster")
...
![Reprojetar funcionalidade no QGIS](_bookdown_files/_main_files/figure-html/media/modulo9/fig98.png "Reprojetar funcionalidade no QGIS")
...
![Janela Warp (reprojetar) QGIS](_bookdown_files/_main_files/figure-html/media/modulo9/fig99_a.png "Janela Warp (reprojetar) QGIS")
...
![HRSL reprojetado](_bookdown_files/_main_files/figure-html/media/modulo9/fig99_b.png "HRSL reprojetado")
...
![Método de reamostragem - vizinho mais próximo](_bookdown_files/_main_files/figure-html/media/modulo9/fig910.png "Método de reamostragem - vizinho mais próximo")
...
![Método de reamostragem - bilinear](_bookdown_files/_main_files/figure-html/media/modulo9/fig911.png "Método de reamostragem - bilinear")
...
**Processamento em lote** é a capacidade de executar processos repetitivos sses de dados, com interação mínima do usuário. A maioria das funcionalidades do QGIS tem esta opção disponível e pode ser ativada na janela de processo clicando no botão **Executar processo em lote** ![Botão Executar processo em lote](_bookdown_files/_main_files/figure-html/media/modulo9/batch-btn.png "botão Executar processo em lote") e alternando para a guia Executar processo em lote (consulte a figura 9.12).


![Guia de processamento em lote em uma janela de funcionalidade QGIS](_bookdown_files/_main_files/figure-html/media/modulo9/fig912.png "Guia de processamento em lote em uma janela de funcionalidade QGIS")
...
![Processamento em lote para reprojetar os rasters de cobertura vegetal](_bookdown_files/_main_files/figure-html/media/modulo9/fig913_a.png "Processamento em lote para reprojetar os rasters de cobertura do solo")

Figura 9.13a - Processamento em lote para reprojetar os rasters de cobertura do solo


![Nomes de saída de preenchimento automático](_bookdown_files/_main_files/figure-html/media/modulo9/fig913_b.png "Nomes de saída de preenchimento automático")

Figura 9.13b - Nomes de saída de preenchimento automático


![Rasters de cobertura de terra reprojetada](_bookdown_files/_main_files/figure-html/media/modulo9/fig913_c.png "Rasters de cobertura de terra reprojetada")
...
![Encontrando a ferramenta de mesclagem GDAL na Caixa de Ferramentas de Processamento](_bookdown_files/_main_files/figure-html/media/modulo9/fig914.png "Encontrando a ferramenta de mesclagem GDAL na Caixa de Ferramentas de Processamento")
...
![Selecionando as camadas SRTM para mesclar](_bookdown_files/_main_files/figure-html/media/modulo9/fig915_a.png "Selecionando as camadas SRTM para mesclar")

Figura 9.15a - Selecionando as camadas SRTM para mesclar


![Parâmetros do algoritmo de processamento de mesclagem](_bookdown_files/_main_files/figure-html/media/modulo9/fig915_b.png " Parâmetros do algoritmo de processamento de mesclagem ")

Figura 9.15b - Parâmetros do algoritmo de processamento de mesclagem


![Mosaico de todos os arquivos DSM correspondentes à nossa região de trabalho](_bookdown_files/_main_files/figure-html/media/modulo9/fig915_c.png "Mosaico de todos os arquivos DSM correspondentes à nossa região de trabalho ")
...
![Reprojetar raster mesclado](_bookdown_files/_main_files/figure-html/media/modulo9/fig915_d.png "Reprojetar raster mesclado")
...
![Processo em lote para extrair informações em um arquivo HTML separado para várias camadas raster](_bookdown_files/_main_files/figure-html/media/modulo9/fig916.png "Processo em lote para extrair informações em um arquivo HTML separado para várias camadas raster")
...
![Janela de histograma](_bookdown_files/_main_files/figure-html/media/modulo9/fig917.png "Janela de histograma")
...
![Ampliando o histograma computado DSM_mosaic_31983](_bookdown_files/_main_files/figure-html/media/modulo9/fig918.png "Ampliando o histograma computado DSM_mosaic_31983")
...
![Selecionando os valores mínimo e máximo para reclassificar o raster](_bookdown_files/_main_files/figure-html/media/modulo9/fig919.png "Selecionando os valores mínimo e máximo para reclassificar o raster")
...
![The Value Tool Panel](_bookdown_files/_main_files/figure-html/media/modulo9/fig920.png "The Value Tool Panel")
...
![Ferramenta de valor carregado - destaque na primeira guia - Tabela](_bookdown_files/_main_files/figure-html/media/modulo9/fig921.png "Ferramenta de valor carregado - destaque na primeira guia - Tabela")
...
![Usando uma máscara vetorial para extrair os dados raster em uma região específica](_bookdown_files/_main_files/figure-html/media/modulo9/fig922.png "Usando uma máscara vetorial para extrair os dados raster em uma região específica")
...
![Processo em lote recortando todas as camadas raster necessárias pela geometria da cidade do Rio de Janeiro](_bookdown_files/_main_files/figure-html/media/modulo9/fig923.png "Processo em lote recortando todas as camadas raster necessárias pela geometria da cidade do Rio de Janeiro")
...
![Camadas raster cortadas pelo contorno da cidade do Rio de Janeiro](_bookdown_files/_main_files/figure-html/media/modulo9/fig924.png "Camadas raster cortadas pelo contorno da cidade do Rio de Janeiro")
...
![Representação Clipped_Reprojected_SRTM_DEM](_bookdown_files/_main_files/figure-html/media/modulo9/fig925.png "representação Clipped_Reprojected_SRTM_DEM")
...
![Abrindo a calculadora raster](_bookdown_files/_main_files/figure-html/media/modulo9/fig926_a.png "Abrindo a calculadora raster")

Figura 9.26a - Abrindo a calculadora raster


![Calculadora raster](_bookdown_files/_main_files/figure-html/media/modulo9/fig926_b.png "Calculadora raster")
...
![Inserindo uma fórmula na Calculadora Raster](_bookdown_files/_main_files/figure-html/media/modulo9/fig927.png "Inserindo uma fórmula na Calculadora Raster")
...
![Resultado da identificação de todos os valores de pixel que estão abaixo de 200 metros usando a Calculadora de Raster](_bookdown_files/_main_files/figure-html/media/modulo9/fig928.png "Resultado de identificar todos os valores de pixel que estão abaixo de 200 metros usando a Calculadora de Raster")
...
![Distribuição espacial de todos os pixels de valor 1, ou seja, com altitude inferior a 200 metros](_bookdown_files/_main_files/figure-html/media/modulo9/fig929.png "Distribuição espacial de todos os pixels de valor 1, ou seja, com altitude inferior a 200 metros")
...
![Usando calculadora raster para identificar classes de distribuição populacional com base na altitude de até 200m](_bookdown_files/_main_files/figure-html/media/modulo9/fig930.png "Usando calculadora raster para identificar classes de distribuição populacional com base na altitude de até 200 m")
...
![Usando a Ferramenta de Valor para verificar os resultados da Calculadora de Raster](_bookdown_files/_main_files/figure-html/media/modulo9/fig931.png "Usando a Ferramenta de Valor para verificar os resultados da Calculadora de Raster")
...
![Distribuição da população que vive abaixo de 200m na ​​cidade do Rio de Janeiro, representada em uma resolução de 30m](_bookdown_files/_main_files/figure-html/media/modulo9/fig932.png "Distribuição da população que vive abaixo de 200m na ​​cidade do Rio de Janeiro, representada em uma resolução de 30m")
...
![Conversão de raster em vetor](_bookdown_files/_main_files/figure-html/media/modulo9/fig933_a.png "Conversão de raster em vetor")
...
![Parâmetros de conversão de varredura em vetor](_bookdown_files/_main_files/figure-html/media/modulo9/fig933_b.png "Parâmetros de conversão de varredura em vetor")
...
![Resultado da conversão de um conjunto de dados raster em um conjunto de dados vetorial](_bookdown_files/_main_files/figure-html/media/modulo9/fig934.png "Resultado da conversão de um conjunto de dados raster em um conjunto de dados vetorial")
...
![Identificando Estatísticas Zonais na Caixa de Ferramentas de Processamento](_bookdown_files/_main_files/figure-html/media/modulo9/fig935.png "Identificando Estatísticas Zonais na Caixa de Ferramentas de Processamento")
...
![Definindo os parâmetros para Estatísticas Zonais](_bookdown_files/_main_files/figure-html/media/modulo9/fig936.png "Definindo os parâmetros para Estatísticas Zonais")
...
![Camada vetorial resultante das estatísticas zonais](_bookdown_files/_main_files/figure-html/media/modulo9/fig937.png "Camada vetorial resultante das estatísticas zonais")
...
![alt_text](_bookdown_files/_main_files/figure-html/media/modulo9/fig938.png "image_tooltip")
...
![alt_text](_bookdown_files/_main_files/figure-html/media/modulo9/fig939.png "image_tooltip ")
...
![alt_text](_bookdown_files/_main_files/figure-html/media/modulo9/fig942.png "image_tooltip")
...
![alt_text](_bookdown_files/_main_files/figure-html/media/modulo9/fig943.png "image_tooltip")
...
![alt_text](_bookdown_files/_main_files/figure-html/media/modulo9/fig944.png "image_tooltip")
...
![alt_text](_bookdown_files/_main_files/figure-html/media/modulo9/fig945.png "image_tooltip")
...
![alt_text](_bookdown_files/_main_files/figure-html/media/modulo9/fig946_a.png "image_tooltip")

Figura 9.46a - Reamostragem do produto de cobertura do solo usando o método de reamostragem do Vizinho mais próximo


![alt_text](_bookdown_files/_main_files/figure-html/media/modulo9/fig946_b.png "image_tooltip")
...
![alt_text](_bookdown_files/_main_files/figure-html/media/modulo9/fig947.png "image_tooltip")
...
![alt_text](_bookdown_files/_main_files/figure-html/media/modulo9/fig948_a.png "image_tooltip")

![alt_text](_bookdown_files/_main_files/figure-html/media/modulo9/fig948_b.png "image_tooltip")

![alt_text](_bookdown_files/_main_files/figure-html/media/modulo9/fig948_c.png "image_tooltip")
...
![alt_text](_bookdown_files/_main_files/figure-html/media/modulo9/fig949.png "image_tooltip")
...
![alt_text](_bookdown_files/_main_files/figure-html/media/modulo9/fig950_a.png "image_tooltip")

Figura 9.50a - Poligonizando a camada raster LC2019_Mode (30m)


![alt_text](_bookdown_files/_main_files/figure-html/media/modulo9/fig950_b.png "image_tooltip")
...
![alt_text](_bookdown_files/_main_files/figure-html/media/modulo9/fig951.png "image_tooltip")
...
![alt_text](_bookdown_files/_main_files/figure-html/media/modulo9/fig952.png "image_tooltip")
...
![alt_text](_bookdown_files/_main_files/figure-html/media/modulo9/fig953_a.png "image_tooltip")

Figura 9.53a - Pixels raster para pontos


![alt_text](_bookdown_files/_main_files/figure-html/media/modulo9/fig953_b.png "image_tooltip")
...
![alt_text](_bookdown_files/_main_files/figure-html/media/modulo9/fig954.png "image_tooltip")
...
![alt_text](_bookdown_files/_main_files/figure-html/media/modulo9/fig955.png "image_tooltip")
...
![alt_text](_bookdown_files/_main_files/figure-html/media/modulo9/fig956.png "image_tooltip")
...
![alt_text](_bookdown_files/_main_files/figure-html/media/modulo9/fig957.png "image_tooltip")
...
![alt_text](_bookdown_files/_main_files/figure-html/media/modulo9/fig958.png "image_tooltip")
...
![alt_text](_bookdown_files/_main_files/figure-html/media/modulo9/fig959.png "image_tooltip")
...
![alt_text](_bookdown_files/_main_files/figure-html/media/modulo9/fig960.png "image_tooltip")
...
![alt_text](_bookdown_files/_main_files/figure-html/media/modulo9/fig961.png "image_tooltip")

Figura 9.61 - Parâmetros do algoritmo de associação de atributos por localização (resumo)


![alt_text](_bookdown_files/_main_files/figure-html/media/modulo9/fig962.png "image_tooltip")
