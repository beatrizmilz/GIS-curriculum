...
![Layout de impressão](_bookdown_files/_main_files/figure-html/media/modulo5/print_comp2.png "Layout de impressão")
...
![Exportando a tela do mapa como imagem](_bookdown_files/_main_files/figure-html/media/modulo5/export-map-canvas-image.png "Exportando a tela do mapa como imagem")

![Exportando o mapa](_bookdown_files/_main_files/figure-html/media/modulo5/export-map-canvas.png "Exportando o mapa ")
...
![Tela do mapa exportada como imagem](_bookdown_files/_main_files/figure-html/media/modulo5/exported-map-canvas.png "Tela do mapa exportada como imagem")
...
![Criando novo layout de impressão](_bookdown_files/_main_files/figure-html/media/modulo5/new-print-layout.png "Criando novo layout de impressão")

Figura 5.4: Criando novo layout de impressão

2. A tela do mapa agora pode ser exportada para o layout de impressão. Clique no 'botão novo layout de impressão' ![Novo layout de impressão](_bookdown_files/_main_files/figure-html/media/modulo5/newprint_composer.png "Novo layout de impressão"). Isso pode ser acessado através da barra de ferramentas. Como alternative, acesse usando a barra de menu 'Projetos'. Uma caixa de diálogo de título será aberta, solicitando que você digite o título do Layout de impressão. Digite 'Rio de Janeiro' e clique em OK.

![Nomeando o layout de impressão](_bookdown_files/_main_files/figure-html/media/modulo5/new-print-layout-name.png "Nomeando o layout de impressão")

Figura 5.5: Nomeando o layout de impressão

3. O layout de impressão será aberto

![A janela Layout de impressão](_bookdown_files/_main_files/figure-html/media/modulo5/new-print-layout-window.png "A janela Layout de impressão")

Figura 5.6: A janela Layout de impressão

4. Você notará que a tela do layout de impressão está vazia. Para adicionar o mapa estilizado da tela QGIS, clique no botão 'Adicionar novo mapa ao layout'![Alt_text](_bookdown_files/_main_files/figure-html/media/modulo5/add_new_map_to_layout.png "image_tooltip"), clique com o botão esquerdo do mouse e desenhe um retângulo no espaço em branco no centro do layout de impressão. O mapa será adicionado. Você acabou de adicionar um mapa para o layout de impressão. Agora é possível adicionar todos os outros elementos do mapa, como título, legenda, grades, etc.

![Adicionar mapa ao layout de impressão](_bookdown_files/_main_files/figure-html/media/modulo5/print-layout-map.png "Adicionar mapa ao layout de impressão")
...
![Barra de escala](_bookdown_files/_main_files/figure-html/media/modulo5/scale-bar.png "Barra de escala")

Figura 5.9: Adicionar barra de escala ao mapa

![Legenda](_bookdown_files/_main_files/figure-html/media/modulo5/legend.png "Legenda")

Figura 5.9: Adicionar legenda ao mapa

![Atribuição](_bookdown_files/_main_files/figure-html/media/modulo5/attribution.png "Atribuição")
...
4. Salve o mapa como uma imagem usando **Layout ‣ Exportar como imagem** ou clicando no botão **Exportar como imagem** ![Exportar mapa como imagem](_bookdown_files/_main_files/figure-html/media/modulo5/export-image-btn. png "Exportar mapa como imagem"). O QGIS irá perguntar a você em qual arquivo salvar o mapa, bem como os parâmetros da imagem.

![Parâmetros de imagem](_bookdown_files/_main_files/figure-html/media/modulo5/img-parameters.png "Parâmetros de imagem")

Figura 5.10: Adicionar atribuição ao mapa

![Mapa exportado como img.](_bookdown_files/_main_files/figure-html/media/modulo5/exported-map.png "Mapa exportado como img.")
...
![Camada de cobertura](_bookdown_files/_main_files/figure-html/media/modulo5/atlas-coverage.png "Camada de cobertura")

Figura 5.12: Camada de cobertura

![Tabela de atributos](_bookdown_files/_main_files/figure-html/media/modulo5/atlas-attr.png "Tabela de atributos")
...
![Layout de impressão do Atlas](_bookdown_files/_main_files/figure-html/media/modulo5/atlas-print-layout.png "Layout de impressão do Atlas")

Figura 5.14: Layout de impressão do Atlas


3. No painel direito do Layout de impressão, certifique-se de selecionar o menu **Atlas** e marque a caixa **Gerar um atlas**. Você também pode abrir as Configurações do Atlas usando o botão Configurações do Atlas ![Configurações do Atlas](_bookdown_files/_main_files/figure-html/media/modulo5/atlas-settings-btn.png "Configurações do Atlas") na barra de ferramentas do Atlas.

![Geração Atlas](_bookdown_files/_main_files/figure-html/media/modulo5/generate-atlas.png "Geração Atlas")
...
![Selecionar camada de cobertura](_bookdown_files/_main_files/figure-html/media/modulo5/coverage-layer.png "Selecionar camada de cobertura")
...
![Controlado pelo Atlas](_bookdown_files/_main_files/figure-html/media/modulo5/atlas-controlled.png "Controlado pelo Atlas")

Figura 5.17: Certifique-se de que a extensão do mapa é controlado pelo Atlas

5. Para visualizar seu Atlas, clique no botão Visualizar Atlas ![Botão Visualizar Atlas](_bookdown_files/_main_files/figure-html/media/modulo5/atlas-preview-btn.png "botão Visualizar Atlas") na barra de ferramentas Atlas. Isso mostrará os 27 mapas que você gerou. Use a barra de ferramentas do Atlas ![Barra de ferramentas do Atlas](_bookdown_files/_main_files/figure-html/media/modulo5/atlas-toolbar-nav.png "Barra de ferramentas do Atlas") para navegar pelos mapas do Atlas.

![Atlas Preview](_bookdown_files/_main_files/figure-html/media/modulo5/atlas-preview.png "Atlas Preview")

Figura 5.18: Atlas Preview

6. Você pode exportar os mapas do Atlas através do botão **Exportar Atlas** ![Botão Exportar Atlas](_bookdown_files/_main_files/figure-html/media/modulo5/atlas-export-btn.png "Botão Exportar Atlas") como imagens ou PDFs. Selecione **Exportar Atlas como imagem**. Você deve gerar 27 mapas, e cada mapa mostrará a extensão de uma das UFs.


![Resultado do Atlas](_bookdown_files/_main_files/figure-html/media/modulo5/atlas-outputs.png "Resultado do Atlas")
