...
![Indo do ponto A ao B usando o Openstreetmap](_bookdown_files/_main_files/figure-html/media/modulo8/fig81.png "Indo do ponto A ao B usando o Openstreetmap")
...
![Linhas de vetor representando ruas e a tabela de atributos associada](_bookdown_files/_main_files/figure-html/media/modulo8/fig82.png "Linhas de vetor representando ruas e a tabela de atributos associada ")
...
![dados vetoriais com tabela de atributos](_bookdown_files/_main_files/figure-html/media/modulo8/fig83.png "dados vetoriais com tabela de atributos")
...
![Elementos de uma operação de geoprocessamento](_bookdown_files/_main_files/figure-html/media/modulo8/fig84.png "elementos de uma operação de geoprocessamento")
...
![Conjuntos de dados vetoriais carregados: pontos, linha e polígonos](_bookdown_files/_main_files/figure-html/media/modulo8/fig85.png "Conjuntos de dados vetoriais carregados: pontos, linha e polígonos")
...
![Especificações do sistema de referência de coordenadas usado no projeto QGIS](_bookdown_files/_main_files/figure-html/media/modulo8/fig86.png "Especificações do sistema de referência de coordenadas usado no projeto QGIS")
...
![Estatísticas básicas para campos](_bookdown_files/_main_files/figure-html/media/modulo8/fig87.png "Estatísticas básicas para campos")
...
![Preparando para executar estatísticas básicas para camada de estradas](_bookdown_files/_main_files/figure-html/media/modulo8/fig88.png "Preparando para executar estatísticas básicas para camada de estradas")
...
![Painel de verificação de topologia](_bookdown_files/_main_files/figure-html/media/modulo8/fig89_a.png "Painel de verificação de topologia")


![Janela de verificação de topologia](_bookdown_files/_main_files/figure-html/media/modulo8/fig89_b.png "Janela de verificação de topologia")
...
![Janela de configurações de regras de topologia](_bookdown_files/_main_files/figure-html/media/modulo8/fig810.png "Janela de configurações de regras de topologia")
...
![Menu suspenso de regras de topologia com base na camada selecionada](_bookdown_files/_main_files/figure-html/media/modulo8/fig811.png "Menu suspenso de regras de topologia com base na camada selecionada")
...
![Regras de topologia a serem definidas](_bookdown_files/_main_files/figure-html/media/modulo8/fig812.png "Regras de topologia a serem definidas")
...
![Resultados da verificação de topologia](_bookdown_files/_main_files/figure-html/media/modulo8/fig813.png "Resultados da verificação de topologia")
...
![Erro de ponto duplicado na camada do vetor de pontos de interesse](_bookdown_files/_main_files/figure-html/media/modulo8/fig814.png "Erro de ponto duplicado na camada do vetor de pontos de interesse")
...
![Excluir geometrias duplicadas nos pontos de interesse da camada](_bookdown_files/_main_files/figure-html/media/modulo8/fig815.png "Excluir geometrias duplicadas nos pontos de interesse da camada")
...
![Resultado da execução da exclusão de geometrias duplicadas](_bookdown_files/_main_files/figure-html/media/modulo8/fig816.png "Resultado da execução da exclusão de geometrias duplicadas")
...
![Verificação de topologia na camada vetorial de edifícios](_bookdown_files/_main_files/figure-html/media/modulo8/fig817_a.png "Verificação de topologia na camada vetorial de edifícios")
...
![Resultados da verificação de topologia na camada vetorial de edifícios](_bookdown_files/_main_files/figure-html/media/modulo8/fig817_b.png "Resultados da verificação de topologia na camada vetorial de edifícios")
...
![Listar valores únicos em uma funcionalidade de camada vetorial](_bookdown_files/_main_files/figure-html/media/modulo8/fig819_a.png "Listar valores únicos em uma funcionalidade de camada vetorial")
...
![Lista valores exclusivos em uma funcionalidade de camada vetorial (Processamento em lote)](_bookdown_files/_main_files/figure-html/media/modulo8/fig819_b.png "Lista valores exclusivos em uma funcionalidade de camada vetorial (Processamento em lote)")
...
![Plugin Group Stats](_bookdown_files/_main_files/figure-html/media/modulo8/fig820_a.png "plugin Group Stats")
...
![Janela Group Stats](_bookdown_files/_main_files/figure-html/media/modulo8/fig820_b.png "Janela Group Stats")
...
![Executando Group Stats na camada de construção](_bookdown_files/_main_files/figure-html/media/modulo8/fig821.png "Executando Group Stats na camada de construção")
...
![Executando Group Stats na camada de estradas](_bookdown_files/_main_files/figure-html/media/modulo8/fig822.png "Executando Group Stats na camada de estradas")
...
![Definindo os parâmetros para um buffer de 500 m ao redor dos locais de culto](_bookdown_files/_main_files/figure-html/media/modulo8/fig823.png "Definindo os parâmetros para um buffer de 500 m ao redor dos locais de culto")
...
![Buffer de execução em uma camada vetorial de ponto](_bookdown_files/_main_files/figure-html/media/modulo8/fig824.png "Running buffer on a point vector layer")
...
![Calcule a área para a camada recém-obtida e, em seguida, calcule usando Group Stats a soma total](_bookdown_files/_main_files/figure-html/media/modulo8/fig825.png "Buffer de execução em Calcule a área para a camada recém-obtida, então calcule usando Group Stats a soma total da camada vetorial")
...
![Figura 8.26a - Selecione landuse fclass = industrial](_bookdown_files/_main_files/figure-html/media/modulo8/fig826_a.png "Figura 8.26a - Selecione landuse fclass = industrial")

Figura 8.26a - Selecione landuse fclass = industrial.


![Seleção reduzida de alguns edifícios e uso do solo industrial, para que o cálculo possa terminar mais rápido](_bookdown_files/_main_files/figure-html/media/modulo8/fig826_b.png "Seleção reduzida de alguns edifícios e uso do solo industrial, para que o cálculo possa terminar mais rápido")
...
![Executando o algoritmo de Clip](_bookdown_files/_main_files/figure-html/media/modulo8/fig827_a.png "Executando o algoritmo de Clip")
...
![Resultados da funcionalidade do clipe](_bookdown_files/_main_files/figure-html/media/modulo8/fig827_b.png "Resultados da funcionalidade do clipe")
...
![Filtrando a camada de poi para obter todas as escolas](_bookdown_files/_main_files/figure-html/media/modulo8/fig828_a.png "Filtrando a camada de poi para obter todas as escolas")

Figura 8.28a - Filtrando a camada de poi para obter todas as escolas


![Todas as escolas na camada de poi](_bookdown_files/_main_files/figure-html/media/modulo8/fig828_b.png "Todas as escolas na camada de poi")

Figura 8.28b - Todas as escolas na camada de poi


![Executando o algoritmo do polígono de Voronoi](_bookdown_files/_main_files/figure-html/media/modulo8/fig828_c.png "Executando o algoritmo do polígono de Voronoi")

Figura 8.28c - Executando o algoritmo do polígono de Voronoi


![Resultados da aplicação do algoritmo de polígonos de Thiessen (Voronoi) a uma camada de vetor de ponto](_bookdown_files/_main_files/figure-html/media/modulo8/fig828_d.png "Resultados da aplicação do algoritmo de polígonos de Thiessen (Voronoi) a uma camada de vetor de ponto")
...
![Criando uma grade vetorial de 2X2km para o Recife](_bookdown_files/_main_files/figure-html/media/modulo8/fig829_a.png "Criando uma grade vetorial 2X2km para Recife")
...
![Grade vetorial de 2X2km para a província de Recife](_bookdown_files/_main_files/figure-html/media/modulo8/fig829_b.png "Grade vetorial de 2X2km para a província de Recife")
...
![Filtrando áreas verdes e espaços construídos em Recife](_bookdown_files/_main_files/figure-html/media/modulo8/fig830_a.png "Filtrando áreas verdes e espaços construídos em Recife")

Figura 8.30a - Filtragem de áreas verdes e espaços construídos em Recife


![Distribuição espacial das áreas verdes e áreas construídas em Recife](_bookdown_files/_main_files/figure-html/media/modulo8/fig830_b.png "Distribuição espacial das áreas verdes e áreas construídas em Recife")
...
![Parâmetros para o algoritmo de interseção](_bookdown_files/_main_files/figure-html/media/modulo8/fig831.png "Parâmetros para o algoritmo de interseção")

Figura 8.31 - Parâmetros para o algoritmo de interseção

O resultado deve ser semelhante ao da figura 8.32.

![Resultado da execução do algoritmo de interseção para prender os polígonos vetoriais de uso do solo à camada da grade](_bookdown_files/_main_files/figure-html/media/modulo8/fig832.png "Resultado da execução do algoritmo de interseção para prender os polígonos vetoriais do uso do solo à camada da grade")
...
![Recursos Landuse cortados por cada célula da grade e sua tabela de atributos associada](_bookdown_files/_main_files/figure-html/media/modulo8/fig833.png "Recursos Landuse cortados por cada célula da grade e sua tabela de atributos associada")
...
![Selecionando os espaços verdes](_bookdown_files/_main_files/figure-html/media/modulo8/fig834_a.png "Selecionando os espaços verdes")

Figura 8.34a - Seleção dos espaços verdes.


![Espaços verdes selecionados](_bookdown_files/_main_files/figure-html/media/modulo8/fig834_b.png "Espaços verdes selecionados")

Figura 8.34b - Espaços verdes selecionados.


![Espaços verdes e construídos](_bookdown_files/_main_files/figure-html/media/modulo8/fig834_c.png "Espaços verdes e construídos")
...
![Calculando a área de cada recurso](_bookdown_files/_main_files/figure-html/media/modulo8/fig834_d.png "Calculando a área de cada recurso")

Figura 8.34d - Calculando a área de cada recurso.

![Configuração de parâmetros GroupStat para somar as áreas verdes por cada célula de grade de 2X2km](_bookdown_files/_main_files/figure-html/media/modulo8/fig834_e.png "Configuração de parâmetros GroupStat para somar as áreas verdes por cada célula de grade 2X2km")
...
![Carregando espacos_verdes_grade CSV](_bookdown_files/_main_files/figure-html/media/modulo8/fig835_a.png "Carregando espacos_verdes_grade CSV")

Figura 8.35a - Carregando o CSV espacos_verdes_grade


![A tabela de atributos CSV espacos_verdes_grade](_bookdown_files/_main_files/figure-html/media/modulo8/fig835_b.png "A tabela de atributos CSV espacos_verdes_grade")
...
Na janela **Uniões**, pressione o botão verde mais abaixo![Botão Adicionar camada de junção](_bookdown_files/_main_files/figure-html/media/modulo8/add_join_btn.png "botão Adicionar camada de junção") e defina os parâmetros como na figura 8.35, para espaços verdes.


![Configurando os parâmetros para unir pelo campo comum grid_id/id as somas dos espaços verdes e construídos para cada célula da grade - unidade de 2X2km](_bookdown_files/_main_files/figure-html/media/modulo8/fig835_c.png "Configurando os parâmetros para unir pelo campo comum grid_id/id as somas de espaços verdes e construídos para cada célula da grade - unidade de 2X2km ")
...
![CSV verde e incorporado unido à grade](_bookdown_files/_main_files/figure-html/media/modulo8/fig836_a.png "CSV verde e incorporado unido à grade")

Figura 8.36a - CSV verde e construído unido à grade.


![Tabela de atributos da camada vetorial Grade contendo as áreas totais para espaços verdes e edificados](_bookdown_files/_main_files/figure-html/media/modulo8/fig836_b.png "Tabela de atributos da camada vetorial Grade contendo as áreas totais para espaços verdes e edificados")
...
![Porcentagem de área verde na grade de 2kmX2km](_bookdown_files/_main_files/figure-html/media/modulo8/fig837_a.png "Porcentagem de área verde na grade de 2kmX2km")

Figura 8.37a - Porcentagem de área verde na grade de 2km X 2km


![Porcentagem calculada de área verde e construída](_bookdown_files/_main_files/figure-html/media/modulo8/fig837_b.png "Porcentagem calculada de área verde e construída")

Figura 8.37b - Porcentagem calculada de área verde e construída


![Calculando para a proporção de áreas verdes e construídas](_bookdown_files/_main_files/figure-html/media/modulo8/fig837_c.png "Calculando para a proporção de áreas verdes e construídas")

Figura 8.37c - Computação para a proporção de áreas verdes e áreas construídas


![Proporção calculada de áreas verdes e edificadas](_bookdown_files/_main_files/figure-html/media/modulo8/fig837_d.png "Proporção calculada de áreas verdes e edificadas")

Figura 8.37d - Razão calculada de áreas verdes e construídas


![Proporção de áreas verdes e construídas na grade de 2kmX2km](_bookdown_files/_main_files/figure-html/media/modulo8/fig837_e.png "Proporção de áreas verdes e áreas construídas na grade de 2kmX2km")
...
![Parâmetros de Soma de Comprimento de Linha](_bookdown_files/_main_files/figure-html/media/modulo8/fig838_a.png "Parâmetros de Soma de Comprimento de Linha")

Figura 8.38a - Parâmetros de Somatórios de Comprimento de Linha


![Comprimentos de estradas e contagens por célula de grade](_bookdown_files/_main_files/figure-html/media/modulo8/fig838_b.png "Comprimento de estradas e contagens por célula de grade")

Figura 8.38b - Comprimentos de estradas e contagens por célula de grade


![Distribuição espacial de unidades de 2X2km com a maioria das estradas](_bookdown_files/_main_files/figure-html/media/modulo8/fig838_c.png "Distribuição espacial de unidades de 2X2km com a maioria das estradas")
...
![Distribuição espacial de unidades de 2X2km com a maioria dos cursos d'água](_bookdown_files/_main_files/figure-html/media/modulo8/fig839.png "Distribuição espacial de unidades de 2X2km com a maioria dos cursos d'água")
...
![Selecionando POIs públicos](_bookdown_files/_main_files/figure-html/media/modulo8/fig840_a.png "Selecionando POIs públicos")

Figura 8.40a - Seleção de POIs públicos


![POIS público selecionado](_bookdown_files/_main_files/figure-html/media/modulo8/fig840_b.png "POIS público selecionado")
...
![Contar POIS públicos em cada grade de 2km X 2km](_bookdown_files/_main_files/figure-html/media/modulo8/fig840_c.png "Contar POIS públicos em cada grade de 2km X 2km")

Figura 8.40c - Contagem de POIS públicos em cada grade de 2km X 2km


![Distribuição espacial da densidade de POIs públicos por unidade 2X2km](_bookdown_files/_main_files/figure-html/media/modulo8/fig840_d.png "Distribuição espacial da densidade de POIs públicos por unidade 2X2km")
...
![Métodos de interpolação disponíveis no QGIS](_bookdown_files/_main_files/figure-html/media/modulo8/fig841.png "Métodos de interpolação disponíveis no QGIS")
...
![Criando pontos aleatórios dentro de uma camada poligonal](_bookdown_files/_main_files/figure-html/media/modulo8/fig842.png "Criando pontos aleatórios dentro de uma camada poligonal")
...
![Camada de dados de ponto - criada aleatoriamente dentro de polígonos especificados](_bookdown_files/_main_files/figure-html/media/modulo8/fig843.png "Camada de dados de ponto - criada aleatoriamente dentro de polígonos especificados")
...
![Criando valores aleatórios dentro dos limites especificados](_bookdown_files/_main_files/figure-html/media/modulo8/fig844.png "Criando valores aleatórios dentro dos limites especificados")
...
![Dados fictícios de precipitação para 93 estações meteorologia fictícias no Recife](_bookdown_files/_main_files/figure-html/media/modulo8/fig845.png "Dados fictícios de precipitação para 93 estações meteorológicas fictícias no Recife")
...
![Configurando a janela de processamento em lote para interpolar os valores de precipitação para todos os 7 dias](_bookdown_files/_main_files/figure-html/media/modulo8/fig846.png "Configurando a janela de processamento em lote para interpolar os valores de precipitação para todos os 7 dias")
...
![Conjuntos de dados interpolados](_bookdown_files/_main_files/figure-html/media/modulo8/fig847.png "Conjuntos de dados interpolados")
...
![Configurando informações temporais para o conjunto de dados raster (1)](_bookdown_files/_main_files/figure-html/media/modulo8/fig848_a.png "Configurando informações temporais para o conjunto de dados raster (1)")


![Configurando informações temporais para o conjunto de dados raster (2)](_bookdown_files/_main_files/figure-html/media/modulo8/fig848_b.png "Configurando informações temporais para o conjunto de dados raster (2)")


![Configurando informações temporais para o conjunto de dados raster (7)](_bookdown_files/_main_files/figure-html/media/modulo8/fig848_c.png "Configurando informações temporais para o conjunto de dados raster (7)")
...
![Defina os parâmetros do Painel de controle de tempo](_bookdown_files/_main_files/figure-html/media/modulo8/fig849.png "Defina os parâmetros do Painel de controle de tempo")

Figura 8.49 - Definir os parâmetros do painel do controlador de tempo.

Clique no botão Reproduzir![Botão Reproduzir](_bookdown_files/_main_files/figure-html/media/modulo8/play-btn.png "Botão Reproduzir") e veja como os valores mudam. Você pode escolher quais outras camadas ficarão visíveis. Na figura 8.50, adicionamos a camada vetorial de edifícios.


![Selecionando outras camadas para serem visíveis na animação temporal](_bookdown_files/_main_files/figure-html/media/modulo8/fig850.png "Selecionando outras camadas para serem visíveis na animação temporal")
