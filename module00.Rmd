...
![A bola de gude azul](media/modulo0/blue-marble.jpg "A bola de gude azul")


É por isso que tradicionalmente usamos globos para representar a Terra.

![Globo de l'Isle (1765)](media/modulo0/globe.jpg "Globo de l'Isle (1765)")
...
2. Que tipo de sistema de referência de coordenadas (geográfico ou projetado) é melhor utilizado para os seguintes casos?
    1. mostrar a localização de pontos usando GPS
    2. calcular a distância entre dois pontos
    3. Verdadeiro ou falso - É possível preservar as seguintes características do mapa juntas em um único mapa:
    4. Área e forma
    5. Distância e direção
...
## Software Livre e de Código Aberto para uso Geoespacial (FOSS4G)
