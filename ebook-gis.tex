...
\subsection{\texorpdfstring{\textbf{Tutorial/Exercício: Mudando a aparência e layout da interface QGIS}}{Tutorial/Exercício: Mudando a aparência e layout da interface QGIS}}\label{tutorialexercuxedcio-mudando-a-aparuxeancia-e-layout-da-interface-qgis}}
...
\hypertarget{quiz-3}{%
\subsection{\texorpdfstring{\textbf{Quiz}}{Quiz}}\label{quiz-3}}
...
\subsection{\texorpdfstring{\textbf{Tutorial/Exercício: Instalando um complemento QGIS}}{Tutorial/Exercício: Instalando um complemento QGIS}}\label{tutorialexercuxedcio-instalando-um-complemento-qgis}}
...
\hypertarget{quiz-4}{%
\subsection{\texorpdfstring{\textbf{Quiz}}{Quiz}}\label{quiz-4}}
...
\subsection{\texorpdfstring{\textbf{Tutorial/Exercício: Criando um Perfil de Usuário}}{Tutorial/Exercício: Criando um Perfil de Usuário}}\label{tutorialexercuxedcio-criando-um-perfil-de-usuuxe1rio}}
...
\hypertarget{quiz-5}{%
\subsection{\texorpdfstring{\textbf{Quiz}}{Quiz}}\label{quiz-5}}
...
\subsubsection{\texorpdfstring{\textbf{Tutorial/Exercício: O painel do navegador}}{Tutorial/Exercício: O painel do navegador}}\label{tutorialexercuxedcio-o-painel-do-navegador}}
...
\subsection{\texorpdfstring{\textbf{Tutorial/Exercício: Adicionando metadados}}{Tutorial/Exercício: Adicionando metadados}}\label{tutorialexercuxedcio-adicionando-metadados}}
...
\subsubsection{\texorpdfstring{\textbf{Tutorial/Exercício: O Gerenciador de fonte de dados}}{Tutorial/Exercício: O Gerenciador de fonte de dados}}\label{tutorialexercuxedcio-o-gerenciador-de-fonte-de-dados}}
...
\subsubsection{\texorpdfstring{\textbf{Tutorial/Exercício: Conectando-se a tiles XYZ}}{Tutorial/Exercício: Conectando-se a tiles XYZ}}\label{tutorialexercuxedcio-conectando-se-a-tiles-xyz}}
...
\hypertarget{quiz-7}{%
\subsection{\texorpdfstring{\textbf{Quiz}}{Quiz}}\label{quiz-7}}
...
\hypertarget{quiz-8}{%
\subsection{\texorpdfstring{\textbf{Quiz}}{Quiz}}\label{quiz-8}}
...
\subsection{\texorpdfstring{\textbf{Exercício/Tutorial: Camadas Virtuais}}{Exercício/Tutorial: Camadas Virtuais}}\label{exercuxedciotutorial-camadas-virtuais}}
...
\subsubsection{\texorpdfstring{\textbf{Tutorial/Exercício: Carregando dados OSM no QGIS usando o plugin QuickOSM}}{Tutorial/Exercício: Carregando dados OSM no QGIS usando o plugin QuickOSM}}\label{tutorialexercuxedcio-carregando-dados-osm-no-qgis-usando-o-plugin-quickosm}}
...
\hypertarget{quiz-9}{%
\subsubsection{\texorpdfstring{\textbf{Quiz}}{Quiz}}\label{quiz-9}}
...
\subsubsection{\texorpdfstring{\textbf{Tutotial/Exercício: Carregando os dados HRSL no QGIS}}{Tutotial/Exercício: Carregando os dados HRSL no QGIS}}\label{tutotialexercuxedcio-carregando-os-dados-hrsl-no-qgis}}
...
\hypertarget{quiz-10}{%
\subsubsection{\texorpdfstring{\textbf{Quiz}}{Quiz}}\label{quiz-10}}
...
\subsection{\texorpdfstring{\textbf{Carregar mais recursos do OSM usando o plug-in QuickOSM}}{Carregar mais recursos do OSM usando o plug-in QuickOSM}}\label{carregar-mais-recursos-do-osm-usando-o-plug-in-quickosm}}
...
\subsection{\texorpdfstring{\textbf{Tutorial/Exercício: Renderização vetorial}}{Tutorial/Exercício: Renderização vetorial}}\label{tutorialexercuxedcio-renderizauxe7uxe3o-vetorial}}
...
\subsection{\texorpdfstring{\textbf{Tutorial/Exercicio: Renderização raster}}{Tutorial/Exercicio: Renderização raster}}\label{tutorialexercicio-renderizauxe7uxe3o-raster}}
...
\hypertarget{quiz-11}{%
\subsubsection{\texorpdfstring{\textbf{Quiz}}{Quiz}}\label{quiz-11}}
...
\subsection{\texorpdfstring{\textbf{Tutorial/Exercício}}{Tutorial/Exercício}}\label{tutorialexercuxedcio}}
...
\subsection{\texorpdfstring{\textbf{Tutorial/Exercício}}{Tutorial/Exercício}}\label{tutorialexercuxedcio-1}}
...
\hypertarget{quiz-12}{%
\subsection{\texorpdfstring{\textbf{Quiz}}{Quiz}}\label{quiz-12}}
...
\subsection{\texorpdfstring{\textbf{Tutorial/Exercício}}{Tutorial/Exercício}}\label{tutorialexercuxedcio-2}}
...
\hypertarget{quiz-13}{%
\subsection{\texorpdfstring{\textbf{Quiz}}{Quiz}}\label{quiz-13}}
...
\subsection{\texorpdfstring{\textbf{Tutorial/Exercício}}{Tutorial/Exercício}}\label{tutorialexercuxedcio-3}}
...
\subsection{\texorpdfstring{\textbf{Tutorial/Exercício}}{Tutorial/Exercício}}\label{tutorialexercuxedcio-4}}
...
\hypertarget{quiz-14}{%
\subsection{\texorpdfstring{\textbf{Quiz}}{Quiz}}\label{quiz-14}}
...
\subsection{\texorpdfstring{\textbf{Tutorial/Exercício}}{Tutorial/Exercício}}\label{tutorialexercuxedcio-5}}
...
\hypertarget{quiz-15}{%
\subsection{\texorpdfstring{\textbf{Quiz}}{Quiz}}\label{quiz-15}}
...
\subsection{\texorpdfstring{\textbf{Tutorial/Exercício}}{Tutorial/Exercício}}\label{tutorialexercuxedcio-6}}
...
\hypertarget{quiz-16}{%
\subsection{\texorpdfstring{\textbf{Quiz}}{Quiz}}\label{quiz-16}}
...
\subsection{\texorpdfstring{\textbf{Tutorial/Exercício}}{Tutorial/Exercício}}\label{tutorialexercuxedcio-7}}
...
\subsection{\texorpdfstring{\textbf{Tutorial/Exercício}}{Tutorial/Exercício}}\label{tutorialexercuxedcio-8}}
...
\hypertarget{quiz-17}{%
\subsection{\texorpdfstring{\textbf{Quiz}}{Quiz}}\label{quiz-17}}
...
\hypertarget{quiz-18}{%
\subsection{\texorpdfstring{\textbf{Quiz}}{Quiz}}\label{quiz-18}}
...
\hypertarget{quiz-19}{%
\subsection{\texorpdfstring{\textbf{Quiz}}{Quiz}}\label{quiz-19}}
...
\hypertarget{quiz-21}{%
\subsection{\texorpdfstring{\textbf{Quiz}}{Quiz}}\label{quiz-21}}
...
\hypertarget{quiz-22}{%
\subsection{\texorpdfstring{\textbf{Quiz}}{Quiz}}\label{quiz-22}}
...
\hypertarget{quiz-24}{%
\subsection{\texorpdfstring{\textbf{Quiz}}{Quiz}}\label{quiz-24}}
...
\hypertarget{quiz-25}{%
\subsection{\texorpdfstring{\textbf{Quiz}}{Quiz}}\label{quiz-25}}
