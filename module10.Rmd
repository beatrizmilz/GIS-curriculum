...
## Introdução à mentalidade do plugin
...
![Plugin oficial do gerenciador](media/modulo10/fig101.png "Plugin oficial do gerenciador")

Figura 10.1 - Plugin oficial do gerenciador


![Exibir plugins experimentais](media/modulo10/fig102_a.png "Exibir plugins experimentais")

Figura 10.2a - Exibir plugins experimentais


![Plugin experimental do plugin Manager](media/modulo10/fig102_b.png "Plugin experimental do plugin Manager")
...
![Adicionar repositório de plugins privado ao seu QGIS](media/modulo10/fig103.png "Adicionar repositório de plugins privado ao seu QGIS")
...
![Buscando um plugin específico no Gerenciador de Plugins](media/modulo10/fig104.png "Buscando um plugin específico no Gerenciador de Plugins")
...
![Documentação de um plugin](media/modulo10/fig105.png "Documentação de um plugin")
...
![Página inicial do plugin selecionado](media/modulo10/fig106_a.png "Página inicial do plugin selecionado")

Figura 10.6a - Página inicial do plugin selecionado


![Metadados detalhados na página inicial do plugin](media/modulo10/fig106_b.png "Metadados detalhados na página inicial do plugin")
...
![Sistema de rastreamento de bug no Github para um plugin QGIS](media/modulo10/fig107.png "Sistema de rastreamento de bug no Github para um plugin QGIS")
...
1. Você precisa do nome completo do plugin para encontrá-lo no Gerenciador de plugins?
    a. **Não, uma palavra-chave é suficiente.**
    b. Sim.
2. Os plugins oficiais e experimentais estão disponíveis no mesmo repositório?
    a. **Sim, desde que a opção 'Mostrar os plugins experimentais' no Plug-in do gerenciador esteja selecionada.**
    b. Não, para experimental existem outros repositórios.
...
![Exemplo de um plugin que requer assinatura externa para funcionar no QGIS em sua capacidade total](media/modulo10/fig108.png "Exemplo de um plugin que requer assinatura externa para funcionar no QGIS em sua capacidade total")
...
![O plugin](media/modulo10/fig109_a.png "O plugin")
...
![Configurando o plugin Discovery](media/modulo10/fig109_b.png "Configurando o plugin Discovery")
...
![Usando o Discovery para pesquisar rapidamente os atributos das camadas vetoriais.](media/modulo10/fig109_c.png "Usando o Discovery para pesquisar rapidamente os atributos das camadas vetoriais.")
...
![Ampliação da geometria do elemento selecionado na barra de pesquisa.](media/modulo10/fig109_d.png "Ampliação da geometria do elemento selecionado na barra de pesquisa.")
...
![O plugin](media/modulo10/fig1010_a.png "O plugin")
...
![Janela do plugin do divisor de polígono](media/modulo10/fig1010_b.png "Janela do plugin do divisor de polígono")
...
![Resultado da execução do plugin Polygon Divider na camada vetorial do Rio](media/modulo10/fig1010_c.png "Resultado da execução do plugin Polygon Divider na camada vetorial do Rio")
...
![O plugin Load Them All](media/modulo10/fig1011_a.png "O plugin Load Them All")
...
![Configurando os parâmetros do plugin Load Them All (vetores e rasters)](media/modulo10/fig1011_b.png "Configurando os parâmetros do plugin Load Them All (vetores e rasters)")
...
![Usando o plugin Load Them All para carregar vários vetores](media/modulo10/fig1011_c.png "Usando o plugin Load Them All para carregar vários vetores")

Figura 10.11c - Usando o plugin Load Them All para carregar vários vetores


![Usando o plugin Load Them All para carregar vários rasters](media/modulo10/fig1011_d.png "Usando o plugin Load Them All para carregar vários rasters")
...
![O plugin Raster tracer](media/modulo10/fig1012_a.png "O plugin Raster tracer")
...
![Configurando os parâmetros do Raster Tracer](media/modulo10/fig1012_b.png "Configurando os parâmetros do Raster Tracer")
...
![Clique nos pontos de inflexão para traçar a linha usando Raster Tracer](media/modulo10/fig1012_c.png "Clique nos pontos de inflexão para traçar a linha usando Raster Tracer")
...
![Linha desenhada semiautomática seguindo a cor indicada.](media/modulo10/fig1012_d.png "Linha desenhada semiautomática seguindo a cor indicada.")
...
![O plugin Active Fire](media/modulo10/fig1013_a.png "O plugin Active Fire")
...
![Usando o plugin Active Fire para carregar produtos de incêndio da NASA no QGIS](media/modulo10/fig1013_b.png "Usando o plugin Active Fire para carregar produtos de incêndio da NASA no QGIS")
...
![O plugin qgis2web](media/modulo10/fig1014_a.png "O plugin qgis2web")
...
![Escolhendo o que seu mapa irá mostrar no navegador](media/modulo10/fig1014_b.png "Escolhendo o que seu mapa irá mostrar no navegador")
...
![QGIS2web preparando os arquivos e pastas necessários para a tecnologia da web OpenLayer 3](media/modulo10/fig1014_c.png "QGIS2web preparando os arquivos e pastas necessários para a tecnologia da web OpenLayer 3")
...
![Abrindo o arquivo index.html em seu navegador](media/modulo10/fig1014_d.png "Abrindo o arquivo index.html em seu navegador")
...
![O plugin DataPlotly](media/modulo10/fig1015_a.png "O plugin DataPlotly")
...
![Janela / painel do DataPlotly.](media/modulo10/fig1015_b.png "Janela / painel do DataPlotly.")
...
![Configurando os parâmetros para o gráfico de pizza que representa os tipos de linhas de água](media/modulo10/fig1015_c.png "Configurando os parâmetros para o gráfico de pizza que representa os tipos de linhas de água")
...
![Tipos de vias navegáveis ​​por gráfico circular de comprimento.](media/modulo10/fig1015_d.png "Tipos de vias navegáveis ​​por gráfico circular de comprimento.")
...
![Teste de conexão interativa da tela do mapa DataPlotly e QGIS](media/modulo10/fig1015_e.png "Teste de conexão interativa da tela do mapa DataPlotly e QGIS")
...
![Atualizar interativamente o gráfico para mostrar apenas os recursos selecionados.](media/modulo10/fig1015_f.png "Atualizar interativamente o gráfico para mostrar apenas os recursos selecionados.")
...
![Atualize o gráfico para mostrar apenas os recursos selecionados na tela do mapa.](media/modulo10/fig1015_g.png "Atualize o gráfico para mostrar apenas os recursos selecionados na tela do mapa.")
...
![Recursos de exportação do DataPlotly](media/modulo10/fig1015_h.png "Recursos de exportação do DataPlotly")
...
![Usando um navegador para abrir o arquivo HTML exportado pelo DataPlotly](media/modulo10/fig1015_i.png "Usando um navegador para abrir o arquivo HTML exportado pelo DataPlotly")
...
![Menu de ajuda para cada tipo de plotagem acessível através da janela do plugin.](media/modulo10/fig1015_j.png "Menu de ajuda para cada tipo de plotagem acessível através da janela do plugin.")
...
![Abrindo o editor de campo no DataPlotly com base nos atributos da camada QGIS selecionada para aplicar uma expressão para filtrar o que o gráfico exibirá](media/modulo10/fig1015_k.png "Abrindo o editor de campo no DataPlotly com base nos atributos da camada QGIS selecionada para aplicar uma expressão para filtrar o que o gráfico exibirá")
...
![Inserindo uma expressão na calculadora de campo](media/modulo10/fig1015_l.png "Inserindo uma expressão na calculadora de campo")
...
![Resultado do DataPlotly da filtragem por expressão](media/modulo10/fig1015_m.png "Resultado do DataPlotly da filtragem por expressão")
...
![Configurando os parâmetros para o primeiro lote - tipos de assentamentos por seus números](media/modulo10/fig1015_n.png "Configurando os parâmetros para o primeiro lote - tipos de assentamentos por seus números")

Figura 10.15n - Configurando os parâmetros para o primeiro lote - tipos de assentamentos por seus números.

![Configuração dos parâmetros para a segunda parcela - tipos de assentamentos por número de população](media/modulo10/fig1015_o.png "Configuração dos parâmetros para a segunda parcela - tipos de assentamentos por número de população")

Figura 10.15o - Configuração dos parâmetros para a segunda parcela - tipos de assentamentos por número de população.


![Subplots em uma linha](media/modulo10/fig1015_p.png "Subplots em uma linha")
...
![plugin QuickMapServices](media/modulo10/fig1016_a1.png "plugin QuickMapServices")


![Plug-in OpenLayers](media/modulo10/fig1016_a2.png "Plug-in OpenLayers")
...
![Localização dos plugins QuickMapServices e OpenLayers](media/modulo10/fig1016_b.png "Localização dos plugins QuickMapServices e OpenLayers")
...
![Usando o plugin OpenLayer](media/modulo10/fig1016_c.png "Usando o plugin OpenLayer")
...
![Dados vetoriais carregados (estradas) sobrepostos ao mapa OSM Standard](media/modulo10/fig1016_d.png "Dados vetoriais carregados (estradas) sobrepostos ao mapa OSM Standard")
...
![O plugin Table to Style](media/modulo10/fig1017_a.png "O plugin Table to Style")
...
![Exemplos de situações em que os valores dos pixels correspondem a uma cor exata](media/modulo10/fig1017_b.png "Exemplos de situações em que os valores dos pixels correspondem a uma cor exata")
...
![QGIS atribui cores aleatoriamente aos valores de pixel](media/modulo10/fig1017_c.png "QGIS atribui cores aleatoriamente aos valores de pixel")
...
![Janela Table2style](media/modulo10/fig1017_d.png "Janela Table2style")
...
![Tabela de atributos com valores de pixel, códigos de cores e descrição para Land Cover](media/modulo10/fig1017_e.png "Tabela de atributos com valores de pixel, códigos de cores e descrição para Land Cover")
...
![Configurando os parâmetros do plugin table2style para o conjunto de dados Land Cover](media/modulo10/fig1017_f.png "Configurando os parâmetros do plugin table2style para o conjunto de dados Land Cover")
...
![Conjunto de dados raster estilizado automaticamente usando o plugin table2style](media/modulo10/fig1017_g.png "Conjunto de dados raster estilizado automaticamente usando o plugin table2style")
...
![O plugin ORS Tools](media/modulo10/fig1018_a.png "O plugin ORS Tools")
...
![Abra a janela de ferramentas ORS](media/modulo10/fig1018_b.png "Abra a janela de ferramentas ORS")
...
![Botão de login](media/modulo10/fig1018_c.png "Botão de login")
...
![Página da conta do Openrouteservice](media/modulo10/fig1018_d.png "Página da conta do Openrouteservice")
...
![E-mail recebido de openrouteservice](media/modulo10/fig1018_e.png "E-mail recebido de openrouteservice")
...
![Solicitar token openrouteservice](media/modulo10/fig1018_f.png "Solicitar token openrouteservice")
...
![Insira a chave openrouteserviceAPI em seu QGIS](media/modulo10/fig1018_g.png "Insira a chave openrouteserviceAPI em seu QGIS")
...
![Inserindo os pontos de roteamento usando ferramentas ORS.](media/modulo10/fig1018_h.png "Inserindo os pontos de roteamento usando ferramentas ORS.")
...
![Resultado da execução de ferramentas ORS](media/modulo10/fig1018_i.png "Resultado da execução de ferramentas ORS")
...
![A rota calculada sobreposta no OpenStreetMap](media/modulo10/fig1018_j.png "A rota calculada sobreposta no OpenStreetMap")
