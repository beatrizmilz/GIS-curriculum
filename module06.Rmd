...
* Camada de limite administrativo do Rio de Janeiro `rj_capital` (dentro de [module6.gpkg](data/module6/module6.gpkg))
* Clínicas do Rio de Janeiro `rj_clinics` (dentro de [module6.gpkg](data/module6/module6.gpkg))
* UFs do Brasil `br_ufs` (dentro de [module6.gpkg](data/module6/module6.gpkg))
* [RJ High Resolution Settlement Layer](data/module6/hrsl_rj_capital_populacao.tif)
...
## Entender e trabalhar com dados de atributos, consultas e análises
