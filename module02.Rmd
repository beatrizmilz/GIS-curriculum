...
## Tipos de dados, formatos de arquivo, o painel do navegador e o painel de camadas
...
#### **Tutorial/Exercício: O painel do navegador**
...
6. Existem 5 arquivos na pasta de dados:
    ...
    1. um GeoPackage (data/module2/br_rj.gpkg) que contém um arquivo vetorial (br_rj_hospitais) e raster (br_rj_srtm_dem);
    2. um GeoJSON (data/module2/br_ufs.geojson);
    3. um arquivo kml (data/module2/br_rj_municipios.kml);
    4. um arquivo de forma (data/module2/br_pais.shp); e
    5. um arquivo de valores separados por vírgula (CSV) (data/module2/br_rj_escolas.csv).
...
### **Tutorial/Exercício: Adicionando metadados**
...
## O gerenciador de fonte de dados e conexão com serviços remotos
...
#### **Tutorial/Exercício: O Gerenciador de fonte de dados**
...
2. **Carregando vetores**
    ...
    2. Vamos carregar o arquivo vetorial (br_rj_hospitais) encontrado dentro do geopackage br_rj. Esta camada é uma camada de pontos das localizações dos hospitais na cidade do Rio de Janeiro.
        ...
        2. Fonte: Selecione o geopackage br_rj usando o botão ![Botão Pesquisar](media/modulo2/data-source-manager-search.png "botão Pesquisar")
...
#### **Tutorial/Exercício: Conectando-se a tiles XYZ**
...
#### **Tutorial/Exercício: Conectando-se a WMS / WMTS e WFS**
...
## Exportando Camadas, Camadas na Memória (Temporárias) e Camadas Virtuais
...
### **Exercício/Tutorial: Camadas Virtuais**
...
4. Ative a edição na camada `arvores` clicando com o botão direito nela > Alterne a edição ou clique ![Alternar símbolo de edição](media/modulo2/symbol-edit.png "Alternar símbolo de edição") na barra de ferramentas de digitalização.
5. Selecione uma área na imagem de satélite que contenha árvores.
6. Com a edição ativada, habilite a adição de pontos à camada Árvores clicando em ![Adicionar novo símbolo de ponto](media/modulo2/symbol-add-point.png "[Adicionar novo símbolo de ponto") (CTRL +.).
